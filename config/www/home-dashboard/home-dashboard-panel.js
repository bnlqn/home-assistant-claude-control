...
})), p, m, h, ee, te, ne, re, ie, ae, oe, se, ce, le, ue, de, fe = t((() => {
	f(), {is: p, defineProperty: m, getOwnPropertyDescriptor: h, getOwnPropertyNames: ee, getOwnPropertySymbols: te, getPrototypeOf: ne} = Object, re = globalThis, ie = re.trustedTypes, ae = ie ? ie.emptyScript : "", oe = re.reactiveElementPolyfillSupport, se = (e, t) => e, ce = {
		toAttribute(e, t) {
			switch (t) {
				case Boolean:
					e = e ? ae : null;
		...
		useDefault: !1,
		hasChanged: le
	}, Symbol.metadata ??= Symbol("metadata"), re.litPropertyMetadata ??= /* @__PURE__ */ new WeakMap(), de = class extends HTMLElement {
...
var he, ge, _e, ve, ye, g, be, xe, _, Se, Ce, we, Te, Ee, De, Oe, ke, v, Ae, je, Me, Ne, y, Pe, Fe, b, x, Ie, Le, Re, ze, Be, Ve, He, Ue, We, Ge, Ke, qe, Je, Ye, Xe = t((() => {
	he = globalThis, ge = (e) => e, _e = he.trustedTypes, ve = _e ? _e.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, ye = "$lit$", g = `lit$${Math.random().toFixed(9).slice(2)}$`, be = "?" + g, xe = `<${be}>`, _ = document, Se = () => _.createComment(""), Ce = (e) => e === null || typeof e != "object" && typeof e != "function", we = Array.isArray, Te = (e) => we(e) || typeof e?.[Symbol.iterator] == "function", Ee = "[ 	\n\f\r]", De = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Oe = /-->/g, ke = />/g, v = RegExp(`>|${Ee}(?:([^\\s"'>=/]+)(${Ee}*=${Ee}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`, "g"), Ae = /'/g, je = /"/g, Me = /^(?:script|style|textarea|title)$/i, Ne = (e) => (t, ...n) => ({
		_$litType$: e,
		strings: t,
		values: n
	}), y = Ne(1), Pe = Ne(2), Fe = Ne(3), b = Symbol.for("lit-noChange"), x = Symbol.for("lit-nothing"), Ie = /* @__PURE__ */ new WeakMap(), Le = _.createTreeWalker(_, 129), Re = (e, t) => {
		let n = e.length - 1, r = [], i, a = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", o = De;
		for (let t = 0; t < n; t++) {
			let n = e[t], s, c, l = -1, u = 0;
			for (; u < n.length && (o.lastIndex = u, c = o.exec(n), c !== null);) u = o.lastIndex, o === De ? c[1] === "!--" ? o = Oe : c[1] === void 0 ? c[2] === void 0 ? c[3] !== void 0 && (o = v) : (Me.test(c[2]) && (i = RegExp("</" + c[2], "g")), o = v) : o = ke : o === v ? c[0] === ">" ? (o = i ?? De, l = -1) : c[1] === void 0 ? l = -2 : (l = o.lastIndex - c[2].length, s = c[1], o = c[3] === void 0 ? v : c[3] === "\"" ? je : Ae) : o === je || o === Ae ? o = v : o === Oe || o === ke ? o = De : (o = v, i = void 0);
			let d = o === v && e[t + 1].startsWith("/>") ? " " : "";
			a += o === De ? n + xe : l >= 0 ? (r.push(s), n.slice(0, l) + ye + n.slice(l) + g + d) : n + g + (l === -2 ? t : d);
		}
		...
		_$AI(e, t = this) {
			e = me(this, e, t), Ce(e) ? e === x || e == null || e === "" ? (this._$AH !== x && this._$AR(), this._$AH = x) : e !== this._$AH && e !== b && this._(e) : e._$litType$ === void 0 ? e.nodeType === void 0 ? Te(e) ? this.k(e) : this._(e) : this.T(e) : this.$(e);
		}
		O(e) {
		...
		_(e) {
			this._$AH !== x && Ce(this._$AH) ? this._$AA.nextSibling.data = e : this.T(_.createTextNode(e)), this._$AH = e;
		}
		$(e) {
			let { values: t, _$litType$: n } = e, r = typeof n == "number" ? this._$AC(e) : (n.el === void 0 && (n.el = ze.createElement(pe(n.h, n.h[0]), this.options)), n);
		...
		_$AI(e, t = this, n, r) {
			...
			if (i === void 0) e = me(this, e, t, 0), a = !Ce(e) || e !== this._$AH && e !== b, a && (this._$AH = e);
			else {
				let r = e, o, s;
				for (e = i[0], o = 0; o < i.length - 1; o++) s = me(this, r[n + o], t, o), s === b && (s = this._$AH[o]), a ||= !Ce(s) || s !== this._$AH[o], s === x ? e = x : e !== x && (e += (s ?? "") + i[o + 1]), this._$AH[o] = s;
			}
			a && !r && this.j(e);
		}
		j(e) {
		...
		B: Ue,
		F: Ke
	}, Je = he.litHtmlPolyfillSupport, Je?.(ze, Ve), (he.litHtmlVersions ??= []).push("3.3.3"), Ye = (e, t, n) => {
	...
	fe(), fe(), Xe(), Xe(), Ze = globalThis, S = class extends de {
		constructor() {
	...
	}, S._$litElement$ = !0, S.finalized = !0, Ze.litElementHydrateSupport?.({ LitElement: S }), Qe = Ze.litElementPolyfillSupport, Qe?.({ LitElement: S }), (Ze.litElementVersions ??= []).push("4.2.2");
})), et = t((() => {})), C = t((() => {
	fe(), Xe(), $e(), et();
})), tt = t((() => {}));
//#endregion
...
function Et(e) {
	...
	return {
		brightness: t.some((e) => Nt.has(e)),
		colorTemp: t.includes("color_temp"),
		color: t.some((e) => Pt.has(e)),
		effects: k(e, Mt.EFFECT)
	};
}
function Dt(e) {
	return {
		...
		close: k(e, Ft.CLOSE),
		stop: k(e, Ft.STOP),
		setPosition: k(e, Ft.SET_POSITION),
		tilt: k(e, Ft.OPEN_TILT) || k(e, Ft.CLOSE_TILT),
		setTilt: k(e, Ft.SET_TILT_POSITION)
	};
}
function Ot(e) {
	return {
		targetTemp: k(e, It.TARGET_TEMPERATURE),
		targetTempRange: k(e, It.TARGET_TEMPERATURE_RANGE),
		fanMode: k(e, It.FAN_MODE),
		presetMode: k(e, It.PRESET_MODE),
		swingMode: k(e, It.SWING_MODE),
		humidity: k(e, It.TARGET_HUMIDITY)
	};
}
function kt(e) {
	return {
		...
		pause: k(e, A.PAUSE),
		stop: k(e, A.STOP),
		next: k(e, A.NEXT_TRACK),
		previous: k(e, A.PREVIOUS_TRACK),
		volumeSet: k(e, A.VOLUME_SET),
		volumeStep: k(e, A.VOLUME_STEP),
		mute: k(e, A.VOLUME_MUTE),
		selectSource: k(e, A.SELECT_SOURCE),
		selectSoundMode: k(e, A.SELECT_SOUND_MODE),
		power: k(e, A.TURN_ON) || k(e, A.TURN_OFF)
	};
}
function At(e) {
	return {
		...
		pause: k(e, j.PAUSE),
		stop: k(e, j.STOP),
		returnHome: k(e, j.RETURN_HOME),
		fanSpeed: k(e, j.FAN_SPEED),
		battery: k(e, j.BATTERY),
		locate: k(e, j.LOCATE)
	};
}
function jt(e) {
	return {
		speed: k(e, Lt.SET_SPEED),
		oscillate: k(e, Lt.OSCILLATE),
		direction: k(e, Lt.DIRECTION),
		presetMode: k(e, Lt.PRESET_MODE)
	};
}
var Mt, Nt, Pt, Ft, It, A, j, Lt, M = t((() => {
	Mt = {
		EFFECT: 4,
		FLASH: 8,
		TRANSITION: 32
...
function Vt(e, t = {}) {
	let n = {};
	return t.brightnessPct != null && (n.brightness_pct = vn(Math.round(t.brightnessPct), 0, 100)), t.colorTempKelvin != null && (n.color_temp_kelvin = Math.round(t.colorTempKelvin)), t.rgbColor && (n.rgb_color = t.rgbColor), t.hsColor && (n.hs_color = [vn(t.hsColor[0], 0, 360), vn(t.hsColor[1], 0, 100)]), t.effect && (n.effect = t.effect), t.transition != null && (n.transition = t.transition), {
		domain: "light",
		service: "turn_on",
		data: P(e, n)
	};
...
function Ht(e, t) {
	let n = vn(Math.round(t), 0, 100);
	return n <= 0 ? Bt(e) : Vt(e, { brightnessPct: n });
}
function Ut(e, t) {
	return {
		domain: "climate",
		service: "set_temperature",
		data: P(e, { temperature: t })
	};
}
function Wt(e, t) {
	return {
...
function Zt(e, t) {
	return {
		...
		data: P(e, { position: vn(Math.round(t), 0, 100) })
	};
}
function Qt(e) {
	return {
...
function tn(e, t) {
	return {
		domain: "media_player",
		service: "volume_set",
		data: P(e, { volume_level: vn(t, 0, 1) })
	};
}
function nn(e, t) {
	return {
...
function gn(e, t) {
	return {
		domain: Ct(e) === "number" ? "number" : "input_number",
		service: "set_value",
		data: P(e, { value: t })
	};
}
function _n(e, t) {
	return {
		...
		data: P(e, { percentage: vn(Math.round(t), 0, 100) })
	};
}
function vn(e, t, n) {
...
function bn(e, t) {
	if (!t) return "—";
	if (wt(t)) return "Unavailable";
	if (Tt(t)) return "Unknown";
...
function Sn(e) {
	...
	return !Number.isNaN(n) && e.state.trim() !== "" ? t ? `${I(n)} ${t}` : I(n) : L(e.state);
}
function I(e, t = 1) {
...
function Cn(e) {
	...
	let n = Math.round((Date.now() - t) / 1e3), r = Math.abs(n), i = wn(), [a, o] = r < 60 ? [-n, "second"] : r < 3600 ? [-Math.round(n / 60), "minute"] : r < 86400 ? [-Math.round(n / 3600), "hour"] : [-Math.round(n / 86400), "day"];
	return r < 45 ? "just now" : i ? i.format(a, o) : `${Math.abs(a)} ${o}${Math.abs(a) === 1 ? "" : "s"} ${a < 0 ? "ago" : "from now"}`;
}
function wn() {
	if (En !== void 0) return En;
	try {
		En = new Intl.RelativeTimeFormat(void 0, { numeric: "auto" });
	} catch {
		En = null;
	}
	return En;
...
function Dn(e, t, n) {
	let r = e?.states[t];
	if (!r || (n.push(t), wt(r) || Tt(r))) return;
	let i = Number(r.state);
	return Number.isFinite(i) ? i : void 0;
}
function On(e, t, n) {
	let r = e?.states[t];
	if (r && (n.push(t), !(wt(r) || Tt(r)))) return r.state || void 0;
}
function kn(e, t) {
	let n = [], r = {
		consumables: [],
	...
	return {
		battery: Dn(e, a + "battery", n),
		status: On(e, a + "status", n),
		room: On(e, a + "current_room", n),
		progress: Dn(e, a + "cleaning_progress", n),
		area: Dn(e, a + "cleaning_area", n),
		cleaningTime: Dn(e, a + "cleaning_time", n),
		consumables: o,
		ids: n
	};
}
...
function Mn(e, t) {
	...
	return n && Fn[e]?.[n] ? Fn[e][n] : In[e] ?? "mdi:help-circle-outline";
}
function Nn(e) {
	return {
...
function Rn(e, t, n) {
	...
	if (!t) return Yn("", r, "mdi:help-circle-outline", "Not configured");
	let i = Ct(t), a = oc(t), o = e?.states[t];
	if (a) return Yn(t, n?.name ?? "Configure me", n?.icon ?? Mn(i, void 0), "Replace placeholder id");
	if (!o) return {
		entityId: t,
		domain: i,
		exists: !1,
		...
		unknown: !1,
		isPlaceholder: !1,
		name: n?.name ?? L(t.split(".")[1] ?? t),
		icon: n?.icon ?? Mn(i, void 0),
		rawState: "missing",
	...
	let s = n?.name ?? yn(o, L(t.split(".")[1] ?? t)), c = wt(o), l = Tt(o), u = {
		entityId: t,
		domain: i,
		stateObj: o,
		exists: !0,
		...
		isPlaceholder: !1,
		name: s,
		icon: n?.icon ?? o.attributes.icon ?? Mn(i, o),
		rawState: o.state,
		displayState: bn(e, o),
		active: !1,
	...
	return c ? (u.secondary = "Unavailable", u) : zn(u, o, n, e);
}
function zn(e, t, n, r) {
	let i = Zn.has(t.state);
	switch (e.domain) {
		case "light": return Bn(e, t, n);
		case "switch":
		case "input_boolean": return e.active = t.state === "on", e.accent = e.active ? "accent" : "idle", e.icon = n?.icon ?? t.attributes.icon ?? Mn(e.domain, t), e.quickAction = {
			kind: "toggle",
		...
		case "climate": return Vn(e, t);
		case "cover": return Hn(e, t);
		case "media_player": return Un(e, t);
		case "lock": return Wn(e, t, n);
		case "vacuum": return Gn(e, t, r);
		case "binary_sensor": return Kn(e, t);
		case "person":
		case "device_tracker": return qn(e, t);
		case "sensor": return Jn(e, t);
		case "weather": return e.icon = Nn(t.state), e.accent = "accent", e.secondary = t.attributes.temperature == null ? void 0 : `${I(t.attributes.temperature)}°`, e;
...
function Vn(e, t) {
	...
	e.displayState = L(n);
	let o = [];
	return i != null && o.push(`${I(i)}°`), a != null && n !== "off" && o.push(`→ ${I(a)}°`), e.secondary = o.join("  "), typeof a == "number" && (e.level = a), e.quickAction = {
		kind: "none",
		label: e.name
	}, e;
}
function Hn(e, t) {
	...
	return e.active = r, e.accent = r ? "accent" : "idle", typeof n == "number" ? (e.level = n, e.secondary = `${n}% open`) : e.secondary = L(t.state), e.quickAction = {
		kind: "none",
		label: e.name
	}, e;
}
function Un(e, t) {
	...
	return e.displayState = r ? "Playing" : L(n), e.secondary = i ?? a ?? o ?? void 0, e.quickAction = {
		kind: "none",
		label: e.name
	}, e;
}
function Wn(e, t, n) {
	...
	return e.active = !r, e.accent = r ? "eco" : "warn", e.icon = r ? "mdi:lock" : "mdi:lock-open-variant", e.displayState = L(t.state), e.quickAction = {
		kind: "toggle",
		label: r ? "Unlock" : "Lock",
		call: r ? fn(e.entityId) : dn(e.entityId),
		requiresConfirmation: r || n?.requiresConfirmation
	}, e;
}
function Gn(e, t, n) {
	let r = t.state, i = r === "cleaning", a = r === "error", o = kn(n, e.entityId);
	e.active = i, e.accent = a ? "alert" : i ? "accent" : "idle";
	let s = L((o.status ?? r).replace(/_/g, " "));
	...
	if (i && typeof o.progress == "number") {
		let t = typeof o.area == "number" && o.area > 0 ? ` · ${I(o.area)} m²` : "";
...
function Kn(e, t) {
	...
	return e.accent = n && r && Qn.has(r) ? "alert" : n ? "accent" : "idle", e.secondary = Cn(t.last_changed), e;
}
function qn(e, t) {
	let n = t.state === "home";
	return e.active = n, e.accent = n ? "eco" : "idle", e.icon = n ? "mdi:home-account" : "mdi:home-export-outline", e.displayState = n ? "Home" : L(t.state), e.secondary = Cn(t.last_changed), e;
}
function Jn(e, t) {
	let n = t.attributes.device_class, r = Number(t.state);
	return e.accent = "idle", n === "battery" && !Number.isNaN(r) && (e.icon = Pn(r, t.attributes.battery_charging ?? !1), e.accent = r <= 15 ? "warn" : "eco"), e.secondary = void 0, e.quickAction = {
		kind: "none",
		label: e.name
	}, e;
}
...
var Zn, Qn, $n = t((() => {
	uc(), M(), R(), F(), jn(), Ln(), Zn = /* @__PURE__ */ new Set([
		"on",
		"open",
		"playing",
		"home",
...
var B = t((() => {})), ar, or, V = t((() => {
	C(), ir(), B(), or = (ar = class extends S {
		constructor(...e) {
			super(...e), this.icon = "", this.size = 24;
		}
		render() {
			let e = rr[this.icon], t = `--hd-icon-size:${this.size}px`;
			if (e) return y`<svg viewBox="0 0 24 24" style=${t} aria-hidden="true">
        ${Pe`<path d=${e}></path>`}
      </svg>`;
			if (typeof customElements < "u" && customElements.get("ha-icon") && this.icon) {
				let e = document.createElement("ha-icon");
				return e.setAttribute("icon", this.icon), e.style.setProperty("--mdc-icon-size", `${this.size}px`), e.style.width = `${this.size}px`, e.style.height = `${this.size}px`, y`${e}`;
			}
			return this.icon ? y`<span class="dot" style=${t}></span>` : x;
		}
	}, ar.styles = l`
    :host {
      display: inline-flex;
  ...
  `, ar), z([w({ type: String })], or.prototype, "icon", void 0), z([w({ type: Number })], or.prototype, "size", void 0), or = z([D("hd-icon")], or);
})), sr, H, U = t((() => {
	C(), E(), O(), $n(), V(), B(), H = (sr = class extends S {
		constructor(...e) {
    ...
    >
      <hd-icon .icon=${this.icon} .size=${24}></hd-icon>
		...
		_titleBlock(e, t) {
			let n = y`<span class="name">${this.name}</span>
      ${this.stateText ? y`<span class="state">${this.stateText}</span>` : x}
      ${this.secondary ? y`<span class="secondary">${this.secondary}</span>` : x}`;
			return e ? y`<button class="titles" aria-label=${t} @click=${this._body}>${n}</button>` : y`<div class="titles">${n}</div>`;
		}
      ...
      <div class="card" data-clickable=${t ? "true" : "false"} style=${e} @click=${this._body}>
        <div class="header">
          ...
          <div class="badge">
            ...
            ${this.hasDetail && this.quickKind === "none" ? y`<hd-icon class="chev" icon="mdi:chevron-right" .size=${20}></hd-icon>` : x}
          </div>
        </div>
    ...
    `;
		...
		_renderTile(e, t, n, r, i) {
			let a = y`<span class="name">${this.name}</span>
      ${this.stateText ? y`<span class="state">${this.stateText}</span>` : x}`;
			return y`
      <div class="card tile" data-clickable=${t ? "true" : "false"} style=${e} @click=${this._body}>
        <div class="tile-top">
          ...
          <span class="accessory">
            <slot name="badge">${this.active ? y`<span class="dot"></span>` : x}</slot>
          </span>
        </div>
        ${t ? y`<button class="tile-foot" aria-label=${i} @click=${this._body}>${a}</button>` : y`<div class="tile-foot">${a}</div>`}
      </div>
    `;
		}
		_renderValue(e, t, n) {
			let r = y`<span class="val-label">${this.name}</span>
      <span class="val-value">
        ${this.stateText ? y`<span>${this.stateText}</span>` : x}
        <slot></slot>
      </span>`;
			return y`
      <div class="card value" data-clickable=${t ? "true" : "false"} style=${e} @click=${this._body}>
        ${t ? y`<button class="val-main" aria-label=${n} @click=${this._body}>${r}</button>` : y`<div class="val-main">${r}</div>`}
  ...
  `, sr), z([w({ type: String })], H.prototype, "icon", void 0), z([w({ type: String })], H.prototype, "name", void 0), z([w({ type: String })], H.prototype, "stateText", void 0), z([w({ type: String })], H.prototype, "secondary", void 0), z([w({ type: String })], H.prototype, "size", void 0), z([w({ type: String })], H.prototype, "accent", void 0), z([w({ type: String })], H.prototype, "glyphColor", void 0), z([w({
		type: Boolean,
		reflect: !0
	})], H.prototype, "active", void 0), z([w({
		type: Boolean,
		reflect: !0
	})], H.prototype, "unavailable", void 0), z([w({ type: Boolean })], H.prototype, "hasDetail", void 0), z([w({ type: String })], H.prototype, "quickKind", void 0), z([w({ type: String })], H.prototype, "quickLabel", void 0), z([w({ type: String })], H.prototype, "actionState", void 0), z([w({ type: Boolean })], H.prototype, "bleed", void 0), z([w({ type: String })], H.prototype, "layout", void 0), H = z([D("hd-widget-frame")], H);
})), cr, lr = t((() => {
	cr = class {
		constructor(e, t) {
	...
	C(), E(), F(), $n(), nr(), U(), lr(), ic(), B(), W = class extends S {
		constructor(...e) {
			super(...e), this.currentSize = "1x1", this.layout = "row", this.actionState = "idle", this._resetTimer = 0, this._hassDependencies = new cr(this, () => this.relevantEntityIds());
		}
		get entityId() {
			return this.config?.entity;
		}
		get vm() {
			return Rn(this.hass, this.entityId, this.config);
		}
		get isConnected2() {
			return this.hass?.connected !== !1;
		}
		relevantEntityIds() {
			return this.config ? Os(this.config) : [];
		}
		hasDetail() {
			return !0;
		}
    ...
    ></hd-widget-frame>`;
		...
		async callService(e, t = {}) {
			if (this.hass) {
				...
				try {
					await Rt(this.hass, e), this.actionState = "success";
				} catch (e) {
					throw this.actionState = "error", tr(this, {
	...
	}, z([w({ attribute: !1 })], W.prototype, "hass", void 0), z([w({ attribute: !1 })], W.prototype, "config", void 0), z([w({ type: String })], W.prototype, "currentSize", void 0), z([w({ type: String })], W.prototype, "layout", void 0), z([T()], W.prototype, "actionState", void 0);
})), ur, K, dr = t((() => {
	C(), E(), O(), V(), B(), K = (ur = class extends S {
		constructor(...e) {
      ...
      >
        <div class="fill"></div>
        <div class="content">
          ${this.icon ? y`<hd-icon .icon=${this.icon} .size=${20}></hd-icon>` : x}
          ${this.valueText ? y`<span class="val">${this.valueText}</span>` : x}
        </div>
      </div>
    `;
		}
  ...
  `, ur), z([w({ type: Number })], K.prototype, "value", void 0), z([w({ type: Number })], K.prototype, "min", void 0), z([w({ type: Number })], K.prototype, "max", void 0), z([w({ type: Number })], K.prototype, "step", void 0), z([w({
		type: Boolean,
		reflect: !0
	})], K.prototype, "vertical", void 0), z([w({
		type: Boolean,
		reflect: !0
	})], K.prototype, "disabled", void 0), z([w({ type: String })], K.prototype, "label", void 0), z([w({ type: String })], K.prototype, "icon", void 0), z([w({ type: String })], K.prototype, "valueText", void 0), z([w({ type: String })], K.prototype, "color", void 0), z([T()], K.prototype, "_dragging", void 0), z([T()], K.prototype, "_dragValue", void 0), K = z([D("hd-slider")], K);
})), fr = /* @__PURE__ */ n({ LightWidget: () => mr }), pr, mr, hr = t((() => {
	C(), E(), O(), G(), M(), F(), U(), dr(), B(), mr = (pr = class extends W {
		constructor(...e) {
		...
		_onInput(e) {
			this._optimistic = e, this._optimisticTs = Date.now(), window.clearTimeout(this._debounce), this._debounce = window.setTimeout(() => {
				this.entityId && this.callService(Ht(this.entityId, e), { errorVerb: "dim" });
			}, 180);
		}
		_onChange(e) {
			this._optimistic = e, this._optimisticTs = Date.now(), window.clearTimeout(this._debounce), this.entityId && this.callService(Ht(this.entityId, e), { errorVerb: "dim" });
		}
		_onTemp(e) {
			this.entityId && this.callService(Vt(this.entityId, { colorTempKelvin: e }), { errorVerb: "set color of" });
		}
		_renderBrightness(e) {
    ...
    ></hd-slider>`;
      ...
      <span class="temp-label">Cool</span>
		...
		renderContent() {
			let e = this.vm, t = Et(e.stateObj), n = this.currentSize, r = t.brightness && (n === "2x1" || n === "1x2" || n === "2x2"), i = n === "1x2", a = t.colorTemp && n === "2x2";
			return y`
      <hd-widget-frame
        .icon=${e.icon}
        .layout=${this.layout}
      ...
      >
        ${r ? y`<div class="col">
              ${i ? this._renderBrightness(!0) : x}
              ${i ? x : this._renderBrightness(!1)}
              ${a ? this._renderTemp() : x}
            </div>` : x}
      </hd-widget-frame>
    `;
		}
  ...
  `, pr), z([T()], mr.prototype, "_optimistic", void 0), mr = z([D("hd-widget-light")], mr);
})), gr, q, _r = t((() => {
	C(), E(), O(), V(), B(), q = (gr = class extends S {
		constructor(...e) {
      ...
      >
        ${this.loading ? y`<span class="spin" role="progressbar"></span>` : y`<hd-icon .icon=${this.icon} .size=${this.size}></hd-icon>`}
      </button>
    `;
		}
	}, gr.styles = l`
  ...
  `, gr), z([w({ type: String })], q.prototype, "icon", void 0), z([w({ type: String })], q.prototype, "label", void 0), z([w({
		type: Boolean,
		reflect: !0
	})], q.prototype, "disabled", void 0), z([w({
		type: Boolean,
		reflect: !0
	})], q.prototype, "loading", void 0), z([w({ type: String })], q.prototype, "variant", void 0), z([w({ type: Number })], q.prototype, "size", void 0), q = z([D("hd-icon-button")], q);
})), vr, yr, br = t((() => {
	C(), E(), O(), V(), B(), yr = (vr = class extends S {
		constructor(...e) {
      ...
      <div class="group" role="radiogroup" aria-label=${this.label}>
        ${this.options.map((e, t) => y`
            ...
            >
              ${e.icon ? y`<hd-icon .icon=${e.icon} .size=${18}></hd-icon>` : x}
              ${e.label ? y`<span>${e.label}</span>` : x}
            </button>
          `)}
      </div>
    `;
  ...
  `, vr), z([w({ attribute: !1 })], yr.prototype, "options", void 0), z([w({ type: String })], yr.prototype, "value", void 0), z([w({
		type: Boolean,
		reflect: !0
	})], yr.prototype, "disabled", void 0), z([w({ type: String })], yr.prototype, "label", void 0), yr = z([D("hd-segmented")], yr);
})), xr = /* @__PURE__ */ n({ ClimateWidget: () => wr }), Sr, Cr, wr, Tr = t((() => {
	C(), E(), O(), G(), M(), F(), R(), U(), _r(), br(), B(), Cr = {
		off: "mdi:power",
		heat: "mdi:fire",
		cool: "mdi:snowflake",
		...
		_step(e) {
			...
			this._optimisticTarget = Number(a.toFixed(1)), this._optimisticTs = Date.now(), this.requestUpdate(), window.clearTimeout(this._debounce), this._debounce = window.setTimeout(() => {
				this.entityId && this.callService(Ut(this.entityId, this._optimisticTarget), { errorVerb: "set temperature for" });
			}, 350);
		}
		_setMode(e) {
			this.entityId && this.callService(Wt(this.entityId, e), { errorVerb: "set mode for" });
		}
		_renderStepper(e) {
      ...
      <div class="stepper ${e ? "center" : ""}">
        <hd-icon-button
          ...
          @click=${() => this._step(-1)}
        ></hd-icon-button>
        <span class="target">${n ? "—" : `${I(this._target)}°`}</span>
        <hd-icon-button
          icon="mdi:plus"
      ...
      ${r == null ? x : y`<div class="now">Now ${I(r)}°</div>`}
    </div>`;
		}
		_renderModes() {
			...
			let n = t.map((e) => ({
				value: e,
				icon: Cr[e] ?? "mdi:thermostat"
			}));
			return y`<div class="modes">
      <hd-segmented
        .options=${n}
        .value=${e.rawState}
      ...
      ></hd-segmented>
		...
		renderContent() {
			let e = this.vm, t = this.currentSize, n = Ot(e.stateObj).targetTemp, r = t === "2x2";
			return y`
      <hd-widget-frame
        .icon=${e.icon}
        .layout=${this.layout}
        .name=${e.name}
        .stateText=${L(e.rawState)}
        ...
        @hd-activate=${() => this.openDetail()}
      >
        ${n ? this._renderStepper(r) : x}
        ${r ? this._renderModes() : x}
      </hd-widget-frame>
    `;
		}
		disconnectedCallback() {
  ...
  `, Sr), z([T()], wr.prototype, "_optimisticTarget", void 0), wr = z([D("hd-widget-climate")], wr);
}));
//#endregion
...
var Dr = t((() => {
	C(), U();
})), Or = /* @__PURE__ */ n({ SwitchWidget: () => kr }), kr, Ar = t((() => {
	O(), G(), Dr(), B(), kr = class extends W {
		renderContent() {
			return Er(this, {
				quickKind: "toggle",
				hasDetail: !0
	...
	}, kr = z([D("hd-widget-switch")], kr);
})), jr = /* @__PURE__ */ n({ FanWidget: () => Nr }), Mr, Nr, Pr = t((() => {
	C(), M(), F(), O(), G(), U(), dr(), B(), Nr = (Mr = class extends W {
		constructor(...e) {
			super(...e), this._debounce = 0;
		}
		_setPercentage(e, t) {
			window.clearTimeout(this._debounce);
			let n = () => this.entityId && this.callService(_n(this.entityId, e), { errorVerb: "set speed for" });
			t ? n() : this._debounce = window.setTimeout(n, 200);
		}
		renderContent() {
			let e = this.vm, t = jt(e.stateObj), n = this.currentSize, r = n === "1x2", i = t.speed && (n === "2x1" || n === "1x2") && e.active, a = e.stateObj?.attributes.percentage ?? 0;
			return y`<hd-widget-frame
      .icon=${e.icon}
      .layout=${this.layout}
      .name=${e.name}
  ...
  `, Mr), Nr = z([D("hd-widget-fan")], Nr);
})), Fr = /* @__PURE__ */ n({ CoverWidget: () => Lr }), Ir, Lr, Rr = t((() => {
	C(), E(), O(), G(), M(), F(), U(), _r(), dr(), B(), Lr = (Ir = class extends W {
		constructor(...e) {
			super(...e), this._optimistic = null, this._optimisticTs = 0, this._debounce = 0;
		}
		get _position() {
		...
		_setPosition(e, t) {
			...
			let n = () => {
				this.entityId && this.callService(Zt(this.entityId, e), { errorVerb: "move" });
			};
			t ? n() : this._debounce = window.setTimeout(n, 200);
		}
		_buttons(e, t) {
			let n = !this.vm.available;
			return y`<div class="controls ${t ? "center" : ""}">
      ${e.open ? y`<hd-icon-button
            icon="mdi:arrow-up"
            label="Open"
            variant="soft"
            .disabled=${n}
            @click=${() => this.entityId && this.callService(Jt(this.entityId), { errorVerb: "open" })}
          ></hd-icon-button>` : x}
      ${e.stop ? y`<hd-icon-button
            icon="mdi:stop"
            label="Stop"
            variant="soft"
            .disabled=${n}
            @click=${() => this.entityId && this.callService(Xt(this.entityId), { errorVerb: "stop" })}
          ></hd-icon-button>` : x}
      ${e.close ? y`<hd-icon-button
            icon="mdi:arrow-down"
            label="Close"
            variant="soft"
            .disabled=${n}
            @click=${() => this.entityId && this.callService(Yt(this.entityId), { errorVerb: "close" })}
          ></hd-icon-button>` : x}
    </div>`;
		}
		renderContent() {
			let e = this.vm, t = Dt(e.stateObj), n = this.currentSize, r = n === "1x2", i = t.setPosition && n !== "1x1", a;
			return a = r && i ? y`<div class="stack">
        <hd-slider
          class="vert"
          vertical
  ...
  `, Ir), z([T()], Lr.prototype, "_optimistic", void 0), Lr = z([D("hd-widget-cover")], Lr);
})), zr = /* @__PURE__ */ n({ LockWidget: () => Br }), Br, Vr = t((() => {
	O(), G(), Dr(), B(), Br = class extends W {
		renderContent() {
			return Er(this, {
				quickKind: "toggle",
				hasDetail: !0
...
var Ur = t((() => {})), Wr = /* @__PURE__ */ n({ VacuumWidget: () => Kr }), Gr, Kr, qr = t((() => {
	C(), O(), G(), M(), F(), R(), jn(), Ur(), U(), _r(), V(), br(), B(), Kr = (Gr = class extends W {
		get _branded() {
		...
		relevantEntityIds() {
			return [...this.entityId ? [this.entityId] : [], ...kn(this.hass, this.entityId).ids];
		}
		_progress() {
			let e = kn(this.hass, this.entityId);
			if (this.vm.rawState !== "cleaning" || typeof e.progress != "number") return x;
			let t = Math.max(0, Math.min(100, Math.round(e.progress))), n = [`${t}%`];
			return typeof e.area == "number" && e.area > 0 && n.push(`${I(e.area)} m²`), typeof e.cleaningTime == "number" && e.cleaningTime > 0 && n.push(`${Math.round(e.cleaningTime)} min`), y`<div class="progress">
      ...
      <div class="meta"><span>${n[0]}</span><span>${n.slice(1).join(" · ")}</span></div>
		...
		_controls(e) {
			...
			return y`<div class="controls" @click=${(e) => e.stopPropagation()}>
      ${n === "cleaning" && e.pause ? y`<hd-icon-button
            icon="mdi:pause"
            label="Pause"
            variant="soft"
            .disabled=${r}
            @click=${() => this.entityId && this.callService(sn(this.entityId), { errorVerb: "pause" })}
          ></hd-icon-button>` : y`<hd-icon-button
            icon="mdi:play"
            label="Start"
            variant="filled"
            .disabled=${r || !e.start}
            @click=${() => this.entityId && this.callService(on(this.entityId), { errorVerb: "start" })}
          ></hd-icon-button>`}
      ${e.returnHome ? y`<hd-icon-button
            icon="mdi:home-import-outline"
            label="Return to dock"
            variant="soft"
            .disabled=${r || n === "docked"}
            @click=${() => this.entityId && this.callService(cn(this.entityId), { errorVerb: "dock" })}
          ></hd-icon-button>` : x}
    </div>`;
		}
		_fanSpeed() {
			...
			return y`<div class="fan">
      <hd-segmented
        .options=${n}
        .value=${e.stateObj?.attributes.fan_speed ?? ""}
        .disabled=${!e.available}
        label="Suction power"
        @hd-select=${(e) => this.entityId && this.callService(ln(this.entityId, e.detail.value), { errorVerb: "set suction for" })}
      ></hd-segmented>
    </div>`;
		}
		_heroControls(e) {
			...
			return y`<div class="controls" @click=${(e) => e.stopPropagation()}>
      ${i && e.pause ? y`<button class="pill primary" aria-label="Pause" ?disabled=${r} @click=${() => a(() => sn(this.entityId), "pause")}>
            <hd-icon icon="mdi:pause" .size=${20}></hd-icon>
          </button>` : y`<button class="pill primary" aria-label="Start" ?disabled=${r || !e.start} @click=${() => a(() => on(this.entityId), "start")}>
            <hd-icon icon="mdi:play" .size=${20}></hd-icon>
          </button>`}
      ${e.returnHome ? y`<button class="pill" aria-label="Return to dock" ?disabled=${r || n === "docked"} @click=${() => a(() => cn(this.entityId), "dock")}>
            <hd-icon icon="mdi:home-import-outline" .size=${20}></hd-icon>
          </button>` : x}
      ${e.locate ? y`<button class="pill" aria-label="Locate" ?disabled=${r} @click=${() => a(() => un(this.entityId), "locate")}>
            <hd-icon icon="mdi:map-marker-radius" .size=${20}></hd-icon>
          </button>` : x}
    </div>`;
		}
		_renderHero(e) {
			let t = this.vm, n = kn(this.hass, this.entityId), r = t.rawState === "cleaning", i = r && typeof n.progress == "number" ? Math.max(0, Math.min(100, Math.round(n.progress))) : void 0, a = [];
			n.battery != null && a.push(`${Math.round(n.battery)}%`), n.area != null && n.area > 0 && a.push(`${I(n.area)} m²`);
			let o = i == null ? x : y`<div class="hprogress">
            <div class="prow">
              <span>${i}%</span>
      ...
      >
        <div class="hero" ?data-cleaning=${r}>
          ...
          <img
            class="robot"
            src=${Hr("assets/roborock-s8.webp")}
            alt=""
            aria-hidden="true"
            draggable="false"
          />
          <div class="top">
            ...
            <div class="htext">
              ...
              ${a.length ? y`<span class="hmeta">${a.join(" · ")}</span>` : x}
            </div>
          </div>
          <div class="bottom">
            ${o}
    ...
    `;
		...
		renderContent() {
			let e = this.vm, t = this.currentSize, n = At(e.stateObj), r = t !== "1x1";
			return this._branded && t === "2x2" && e.exists ? this._renderHero(n) : y`
      <hd-widget-frame
        .icon=${e.icon}
        .layout=${this.layout}
        .name=${e.name}
        ...
        @hd-activate=${() => this.openDetail()}
      >
        ${r ? this._controls(n) : x} ${t === "1x1" ? x : this._progress()}
        ${t === "2x2" ? this._fanSpeed() : x}
      </hd-widget-frame>
    `;
		}
	}, Gr.styles = l`
  ...
  `, Gr), Kr = z([D("hd-widget-vacuum")], Kr);
}));
//#endregion
//#region src/home-assistant/media-apps.ts
function Jr(e) {
	return Qr[e.replace(/\u00a0/g, " ").trim().toLowerCase()];
}
function Yr(e) {
	return e.some((e) => Jr(e) !== void 0);
}
function Xr(e) {
...
function ii(e) {
	if (li.has(e)) return Promise.resolve(li.get(e) ?? null);
	let t = ui.get(e);
	if (t) return t;
	let n = ai(e).then((t) => (li.set(e, t), ui.delete(e), t)).catch(() => (li.set(e, null), ui.delete(e), null));
	return ui.set(e, n), n;
}
function ai(e) {
	return new Promise((t) => {
		let n = new Image();
		n.crossOrigin = "anonymous", n.decoding = "async", n.onload = () => t(oi(n)), n.onerror = () => t(null), n.src = e;
	});
}
function oi(e) {
...
function ci({ r: e, g: t, b: n }, r = 1) {
	return r >= 1 ? `rgb(${e}, ${t}, ${n})` : `rgba(${e}, ${t}, ${n}, ${r})`;
}
var li, ui, di = t((() => {
	li = /* @__PURE__ */ new Map(), ui = /* @__PURE__ */ new Map();
})), fi = /* @__PURE__ */ n({ MediaWidget: () => gi }), pi, mi, hi, gi, _i = t((() => {
	C(), E(), O(), G(), M(), ei(), ni(), di(), F(), U(), _r(), B(), mi = {
		r: 32,
		g: 36,
		b: 44
	}, hi = 1600, gi = (pi = class extends W {
		constructor(...e) {
		...
		get _isPlaying() {
			...
			if (this._optimistic != null) {
				if (Date.now() - this._optimisticTs > hi) return this._optimistic = null, e;
		...
		_playPause() {
			this.entityId && (this._optimistic = this._isPlaying ? "paused" : "playing", this._optimisticTs = Date.now(), this.callService(Qt(this.entityId), { errorVerb: "control" }));
		}
		willUpdate() {
		...
		_syncTicker() {
			let e = this._isPlaying && !!ti(this.vm.stateObj);
		...
		_ambientVars() {
			let e = this._artColor ?? mi;
			return [
				`--np-dark:${ci(si(e, .62))}`,
				`--np-scrim-strong:${ci(si(e, .55), .9)}`,
				`--np-scrim-soft:${ci(si(e, .35), .45)}`
			].join(";");
		}
		_transport(e) {
			let t = !this.vm.available || this._rawState === "off", n = this._rawState === "buffering";
			return y`<div class="np-transport" @click=${(e) => e.stopPropagation()}>
      ${e.previous ? y`<hd-icon-button
            icon="mdi:skip-previous"
            label="Previous"
            variant="plain"
            .disabled=${t}
            @click=${() => this.entityId && this.callService(en(this.entityId), { errorVerb: "skip" })}
          ></hd-icon-button>` : x}
      <span class="np-play">
        <hd-icon-button
      ...
      ${e.next ? y`<hd-icon-button
		...
		renderContent() {
			let e = this.vm, t = kt(e.stateObj), n = this.currentSize, r = e.stateObj?.attributes.entity_picture, i = e.stateObj?.attributes.app_name, a = e.stateObj?.attributes.media_title, o = this._rawState, s = i ? Jr(i) : void 0;
			if (o === "off" || (o === "idle" || o === "standby") && !(r || i || a)) return y`
        <hd-widget-frame
          .icon=${e.icon}
          .name=${e.name}
          ...
          @hd-activate=${() => this.openDetail()}
        >
          ${t.play || t.pause ? this._transportPlain(t) : x}
        </hd-widget-frame>
      `;
			let c = n === "2x2", l = ti(e.stateObj), u = r ? `background-image:url("${r}")` : "";
			return y`
      <hd-widget-frame
        bleed
        .name=${e.name}
        ...
        <div class="np" data-variant=${c ? "hero" : "bar"} style=${this._ambientVars()}>
          ...
          <div class="np-body">
            <div class="np-art" style=${c ? "" : u}>
              ${r ? x : y`<hd-icon icon=${s ?? "mdi:music-note"} .size=${c ? 56 : 26}></hd-icon>`}
            </div>
            <div class="np-meta">
          ...
          ${l ? y`<div class="np-progress"><span style=${`width:${l.pct}%`}></span></div>` : x}
        </div>
      </hd-widget-frame>
    `;
		}
		_transportPlain(e) {
			...
			return y`<div class="transport" @click=${(e) => e.stopPropagation()}>
      <hd-icon-button
        icon=${this._isPlaying ? "mdi:pause" : "mdi:play"}
        label="Play or pause"
        variant="filled"
  ...
  `, pi), z([T()], gi.prototype, "_artColor", void 0), z([T()], gi.prototype, "_marquee", void 0), gi = z([D("hd-widget-media")], gi);
}));
//#endregion
//#region src/home-assistant/history.ts
async function vi(e, t, n = 24) {
...
var yi = t((() => {})), bi, xi, Si, Ci, wi, Ti, Ei, Di, Oi = t((() => {
	C(), E(), O(), V(), B(), wi = (bi = class extends S {
		constructor(...e) {
  ...
  `, bi), z([w({ type: Number })], wi.prototype, "value", void 0), z([w({ type: String })], wi.prototype, "color", void 0), z([w({ type: String })], wi.prototype, "label", void 0), wi = z([D("hd-progress")], wi), Ti = (xi = class extends S {
		constructor(...e) {
			super(...e), this.icon = "", this.text = "", this.tone = "neutral";
		}
		render() {
			return y`<span class="badge"
      >${this.icon ? y`<hd-icon .icon=${this.icon} .size=${14}></hd-icon>` : x}
      ${this.text ? y`<span>${this.text}</span>` : x}</span
    >`;
		}
	}, xi.styles = l`
    :host {
  ...
  `, xi), z([w({ type: String })], Ti.prototype, "icon", void 0), z([w({ type: String })], Ti.prototype, "text", void 0), z([w({ type: String })], Ti.prototype, "tone", void 0), Ti = z([D("hd-status-badge")], Ti), Ei = (Si = class extends S {
		constructor(...e) {
			super(...e), this.w = "100%", this.h = "16px", this.radius = "8px";
		}
		render() {
			return y`<div class="sk" style=${`--w:${this.w};--h:${this.h};--r:${this.radius}`}></div>`;
		}
	}, Si.styles = l`
    :host {
      display: block;
  ...
  `, Si), z([w({ type: String })], Ei.prototype, "w", void 0), z([w({ type: String })], Ei.prototype, "h", void 0), z([w({ type: String })], Ei.prototype, "radius", void 0), Ei = z([D("hd-skeleton")], Ei), Di = (Ci = class extends S {
		constructor(...e) {
			super(...e), this.points = [], this.color = "var(--accent)", this.area = !0, this.summary = "";
		}
		render() {
			let e = this.points.filter((e) => Number.isFinite(e));
			if (e.length < 2) return y`<svg viewBox="0 0 100 32" preserveAspectRatio="none" aria-label=${this.summary}></svg>`;
			...
			return y`<svg viewBox="0 0 ${100} ${32}" preserveAspectRatio="none" role="img" aria-label=${this.summary}
      style=${`--trend-color:${this.color}`}
      >${this.area ? Pe`<path class="fill" d=${a}></path>` : x}
      ${Pe`<path class="line" d=${i}></path>`}</svg
    >`;
		}
	}, Ci.styles = l`
    :host {
  ...
  `, Ci), z([w({ attribute: !1 })], Di.prototype, "points", void 0), z([w({ type: String })], Di.prototype, "color", void 0), z([w({ type: Boolean })], Di.prototype, "area", void 0), z([w({ type: String })], Di.prototype, "summary", void 0), Di = z([D("hd-trend")], Di);
})), ki, Ai = t((() => {
	ki = class {
		constructor(e, t) {
		...
		load(e, t) {
			if (!e || e === this.key && (this.status === "loading" || this.status === "ready")) return;
			this.key = e, this.status = "loading", this.error = void 0;
			let n = ++this.generation;
			t().then((e) => {
				!this.connected || n !== this.generation || (this.value = e, this.status = "ready", this.host.requestUpdate());
			}, (e) => {
				!this.connected || n !== this.generation || (this.error = e, this.status = "error", this.host.requestUpdate());
			});
		}
		reset() {
...
var Ni, Pi, Fi = t((() => {
	C(), O(), G(), yi(), $n(), U(), Oi(), Ai(), B(), Pi = (Ni = class extends W {
		constructor(...e) {
			super(...e), this._trend = new ki(this, () => []);
		}
		get _isBig() {
		...
		updated() {
			if (this._isBig && this.entityId && this.hass?.connected) {
				...
				if (e && Number.isFinite(Number(e.state))) {
					...
					this._trend.load(t, async () => (await vi(e, t, 24)).map((e) => e.value));
				}
			}
			this._isBig ? this.setAttribute("data-big", "") : this.removeAttribute("data-big");
		}
		renderContent() {
			let e = this.vm, t = e.stateObj, n = t ? Number(t.state) : NaN, r = Number.isFinite(n) && t.state.trim() !== "", i = t?.attributes.unit_of_measurement, a = Xn(e.accent), o = e.available && r ? y`<div class="value">
            <span>${Mi(n)}</span>${i ? y`<span class="unit">${i}</span>` : x}
          </div>` : y`<div class="value"><span class="txt">${e.displayState}</span></div>`;
			return y`
      <hd-widget-frame
        .icon=${e.icon}
        .layout=${this.layout}
      ...
      >
        ${o}
        ${this._isBig && r && this._trend.value.length > 1 ? y`<div class="trend">
              <hd-trend
  ...
  `, Ni), Pi = z([D("hd-widget-sensor")], Pi);
})), Ii = /* @__PURE__ */ n({ WeatherWidget: () => Ri }), Li, Ri, zi = t((() => {
	C(), O(), G(), Ln(), R(), U(), V(), Ai(), B(), Ri = (Li = class extends W {
		constructor(...e) {
			super(...e), this._forecast = new ki(this, () => []);
		}
		hasDetail() {
			return !0;
		}
		...
		_metrics() {
			...
			return e.humidity != null && t.push(["mdi:water-percent", `${Math.round(e.humidity)}%`]), e.wind_speed != null && t.push(["mdi:weather-windy", `${I(e.wind_speed)} ${e.wind_speed_unit ?? "km/h"}`]), y`<div class="metrics">
      ${t.map(([e, t]) => y`<span class="metric"><hd-icon .icon=${e} .size=${14}></hd-icon>${t}</span>`)}
    </div>`;
		}
		_forecastStrip() {
			return this._forecast.value.length ? y`<div class="forecast">
      ${this._forecast.value.map((e) => {
				let t = new Date(e.datetime), n = Number.isNaN(t.getTime()) ? "" : t.toLocaleDateString(void 0, { weekday: "short" });
				return y`<div class="day">
          <span class="dow">${n}</span>
          <hd-icon .icon=${Nn(e.condition ?? "")} .size=${20}></hd-icon>
          <span class="hi">${e.temperature == null ? "–" : `${Math.round(e.temperature)}°`}</span>
          ${e.templow == null ? x : y`<span class="lo">${Math.round(e.templow)}°</span>`}
        </div>`;
			})}
    </div>` : x;
		}
		renderContent() {
			let e = this.vm, t = e.stateObj?.attributes ?? {}, n = this.currentSize, r = n === "1x2" || n === "2x2", i = t.temperature == null ? "—" : `${I(t.temperature)}°`, a = this.layout === "value";
			return y`
      <hd-widget-frame
        .icon=${Nn(e.rawState)}
        .layout=${this.layout}
        .name=${e.name}
        .stateText=${a ? i : L(e.rawState)}
        .size=${n}
        .accent=${"accent"}
        .active=${!1}
        .unavailable=${!e.available}
        ...
        @hd-activate=${() => this.openDetail()}
      >
        ${a ? x : y`<div class="temp">${i}</div>
              ${this._metrics()} ${r ? this._forecastStrip() : x}`}
      </hd-widget-frame>
    `;
		}
	}, Li.styles = l`
  ...
  `, Li), Ri = z([D("hd-widget-weather")], Ri);
})), Bi = /* @__PURE__ */ n({ BinarySensorWidget: () => Vi }), Vi, Hi = t((() => {
	O(), G(), Dr(), U(), B(), Vi = class extends W {
		renderContent() {
			return Er(this, {
				quickKind: "none",
				hasDetail: !0
	...
	}, Vi = z([D("hd-widget-binary")], Vi);
})), Ui = /* @__PURE__ */ n({ PersonWidget: () => Wi }), Wi, Gi = t((() => {
	O(), G(), Dr(), U(), B(), Wi = class extends W {
		renderContent() {
			return Er(this, {
				quickKind: "none",
				hasDetail: !0
	...
	}, Wi = z([D("hd-widget-person")], Wi);
})), Ki = /* @__PURE__ */ n({ CameraWidget: () => Ji }), qi, Ji, Yi = t((() => {
	C(), E(), O(), G(), U(), B(), Ji = (qi = class extends W {
		constructor(...e) {
    ...
    >
      <div class="tile">
        ${n && e.available ? y`<img src=${n} alt=${`Live view of ${e.name}`} loading="lazy" />` : y`<div class="off"><hd-icon icon="mdi:cctv" .size=${34}></hd-icon><span>${e.displayState}</span></div>`}
  ...
  `, qi), z([T()], Ji.prototype, "_cacheBust", void 0), Ji = z([D("hd-widget-camera")], Ji);
})), Xi, Zi = t((() => {
	C(), nr(), G(), U(), Xi = class extends W {
		hasDetail() {
			return !1;
		}
		async activate() {
			let e = this.vm, t = e.quickAction;
			if (!(!t.call || !this.isConnected2) && !(t.requiresConfirmation && !await er(this, {
				title: `${t.label} ${e.name}?`,
				confirmLabel: t.label
			}))) try {
				await this.callService(t.call, { errorVerb: t.label.toLowerCase() }), tr(this, {
...
})), Qi = /* @__PURE__ */ n({ SceneWidget: () => $i }), $i, ea = t((() => {
	O(), Zi(), B(), $i = class extends Xi {}, $i = z([D("hd-widget-scene")], $i);
})), ta = /* @__PURE__ */ n({ ScriptWidget: () => na }), na, ra = t((() => {
	O(), Zi(), B(), na = class extends Xi {}, na = z([D("hd-widget-script")], na);
})), ia = /* @__PURE__ */ n({ ButtonWidget: () => aa }), aa, oa = t((() => {
	O(), Zi(), B(), aa = class extends Xi {}, aa = z([D("hd-widget-button")], aa);
})), sa = /* @__PURE__ */ n({ AlarmWidget: () => la }), ca, la, ua = t((() => {
	C(), R(), nr(), O(), G(), U(), B(), la = (ca = class extends W {
		async _call(e, t) {
			!this.entityId || !this.hass || t && !await er(this, {
				title: `${L(e.replace("alarm_", "").replace("_", " "))}?`,
      ...
      @hd-activate=${() => this.openDetail()}
    >
      ${this.currentSize === "1x1" ? x : y`<div class="controls" @click=${(e) => e.stopPropagation()}>
            ${r ? y`<button class="danger" @click=${() => this._call("alarm_disarm", !0)}>Disarm</button>` : y`<button @click=${() => this._call("alarm_arm_home", !1)}>Arm home</button>
  ...
  `, ca), la = z([D("hd-widget-alarm")], la);
})), da = /* @__PURE__ */ n({ ActionWidget: () => fa }), fa, pa = t((() => {
	C(), nr(), O(), G(), U(), B(), fa = class extends W {
		constructor(...e) {
		...
		async _run() {
			...
			if (!(!t || !n) && !(this.config.requiresConfirmation && !await er(this, {
				title: `${this.config.name ?? "Run"}?`,
				confirmLabel: this.config.name ?? "Run"
			}))) {
				this.actionState = "pending";
				try {
					await this.hass.callService(t, n, e.data, e.target), this.actionState = "success", tr(this, {
						message: this.config.name ?? "Done",
						tone: "eco",
						icon: "mdi:check"
					});
				} catch {
					this.actionState = "error", tr(this, {
...
})), va, ya, ba, xa, Sa, Ca, wa, Ta, Ea, Da = t((() => {
	Xe(), {I: va} = qe, ya = (e) => e, ba = () => document.createComment(""), xa = (e, t, n) => {
		let r = e._$AA.parentNode, i = t === void 0 ? e._$AB : t._$AA;
		if (n === void 0) {
			let t = r.insertBefore(ba(), i), a = r.insertBefore(ba(), i);
			n = new va(t, a, e, e.options);
		} else {
			...
			if (t !== i || o) {
				let e = n._$AA;
				for (; e !== t;) {
					let t = ya(e).nextSibling;
					ya(r).insertBefore(e, i), e = t;
				}
			}
		}
		return n;
	}, Sa = (e, t, n = e) => (e._$AI(t, n), e), Ca = {}, wa = (e, t = Ca) => e._$AH = t, Ta = (e) => e._$AH, Ea = (e) => {
	...
	Xe(), _a(), Da(), Oa = (e, t, n) => {
		...
		update(e, [t, n, r]) {
			let i = Ta(e), { values: a, keys: o } = this.dt(t, n, r);
			if (!Array.isArray(i)) return this.ut = o, a;
			let s = this.ut ??= [], c = [], l, u, d = 0, f = i.length - 1, p = 0, m = a.length - 1;
			for (; d <= f && p <= m;) if (i[d] === null) d++;
			else if (i[f] === null) f--;
			else if (s[d] === o[p]) c[p] = Sa(i[d], a[p]), d++, p++;
			else if (s[f] === o[m]) c[m] = Sa(i[f], a[m]), f--, m--;
			else if (s[d] === o[m]) c[m] = Sa(i[d], a[m]), xa(e, c[m + 1], i[d]), d++, m--;
			else if (s[f] === o[p]) c[p] = Sa(i[f], a[p]), xa(e, i[d], i[f]), f--, p++;
			else if (l === void 0 && (l = Oa(o, p, m), u = Oa(s, d, f)), l.has(s[d])) {
				if (l.has(s[f])) {
					let t = u.get(o[p]), n = t === void 0 ? null : i[t];
					if (n === null) {
						let t = xa(e, i[d]);
						Sa(t, a[p]), c[p] = t;
					} else c[p] = Sa(n, a[p]), xa(e, i[d], n), i[t] = null;
					p++;
				} else Ea(i[f]), f--;
			} else Ea(i[d]), d++;
			for (; p <= m;) {
...
function Va(e) {
	...
	for (let e of t) {
		let t = La(e.type), r = n.get(t) ?? [];
		r.push(e), n.set(t, r);
	}
	let r = [];
	for (let e of Ha) {
		let t = n.get(e);
		t && t.length && r.push(Ba(e, t));
	}
	return r;
}
var Ha, Ua, Wa, Ga = t((() => {
...
})), Ka, qa, Ja, Ya, Xa, Za, Qa = t((() => {
	Xe(), Ka = Symbol.for(""), qa = (e) => {
		if (e?.r === Ka) return e?._$litStatic$;
	}, Ja = (e) => ({
		_$litStatic$: e,
		r: Ka
	}), Ya = /* @__PURE__ */ new Map(), Xa = (e) => (t, ...n) => {
		let r = n.length, i, a, o = [], s = [], c, l = 0, u = !1;
		for (; l < r;) {
			for (c = t[l]; l < r && (a = n[l], (i = qa(a)) !== void 0);) c += i + t[++l], u = !0;
			l !== r && s.push(a), o.push(c), l++;
		}
		if (l === r && o.push(t[r]), u) {
			let e = o.join("$$lit$$");
			(t = Ya.get(e)) === void 0 && (o.raw = o, Ya.set(e, t = o)), n = s;
		}
		return e(t, ...n);
	}, Za = Xa(y), Xa(Pe), Xa(Fe);
})), $a = t((() => {
...
var no, ro = t((() => {
	ic(), no = /* @__PURE__ */ new Map();
}));
//#endregion
//#region src/panel/widget-cell.ts
function io(e, t, n, r, i = "row") {
	try {
		let { colSpan: a, rowSpan: o } = Fa(t, n), s = Ja(to(e.type)), c = `grid-column: span ${a}; grid-row: span ${o};`;
		return Za`<${s}
      class="cell"
      style=${c}
      .hass=${r}
    ...
    ></${s}>`;
		...
		return console.error(`[widget-cell] widget "${e?.id ?? e?.type}" failed to render:`, r), ao(e, t, n);
	}
}
function ao(e, t, n) {
	let r = 1, i = 1;
	try {
		({colSpan: r, rowSpan: i} = Fa(t, n));
	} catch {}
...
var oo = t((() => {
	...
	so = class {
		constructor(e, t) {
			this.host = e, this.resolve = t, this.width = 0, this.frame = 0, this.pendingWidth = 0, e.addController(this);
		}
		get profile() {
			return this.resolve(this.width);
		}
		hostConnected() {
			this.width = Math.round(this.host.getBoundingClientRect().width || window.innerWidth), this.observer = new ResizeObserver(([e]) => {
				let t = Math.round(e?.contentRect.width ?? 0);
				!t || Math.abs(t - this.width) <= 1 || (this.pendingWidth = t, !this.frame && (this.frame = requestAnimationFrame(() => {
					this.frame = 0;
...
})), lo = /* @__PURE__ */ n({ HdGroup: () => fo }), uo, fo, po = t((() => {
	C(), E(), ja(), O(), Ga(), oo(), co(), B(), fo = (uo = class extends S {
		constructor(...e) {
			super(...e), this.currentSize = "4x2", this.layout = "row", this._responsive = new so(this, Ma);
		}
		get _opts() {
		...
		get _variant() {
			return this._opts.variant ?? La(this._children[0]?.type ?? "sensor");
		}
		render() {
			let e = this._children;
			if (!e.length) return x;
			let t = this._responsive.width, n = this._variant, r = za(n, t), i = this._responsive.profile.bucket, a = Ra(n), o = this._opts.label, s = a !== "row", c = `--cols:${r}; --gap:12px; --unit:${n === "sensors" ? 84 : n === "media" ? 116 : n === "tiles" ? 100 : Ia(t || 1024, {
				columns: r,
				gap: 12,
				pad: 0,
				bucket: i
      ...
      <section class="section">
        ${o ? y`<h2 class="head">${o}</h2>` : x}
        <div class="grid" style=${c}>
          ${ka(e, (e) => e.id, (e) => {
				let t = s ? Pa(e, i) : null;
				return io(e, t ?? (s ? "1x1" : Na(e, i)), r, this.hass, t ? "row" : a);
			})}
        </div>
      </section>
    `;
  ...
  `, uo), z([w({ attribute: !1 })], fo.prototype, "hass", void 0), z([w({ attribute: !1 })], fo.prototype, "config", void 0), z([w({ type: String })], fo.prototype, "currentSize", void 0), z([w({ type: String })], fo.prototype, "layout", void 0), fo = z([D("hd-group")], fo);
})), mo = /* @__PURE__ */ n({ EnergyWidget: () => go }), ho, go, _o = t((() => {
	C(), O(), G(), yi(), R(), U(), Oi(), Ai(), B(), go = (ho = class extends W {
		constructor(...e) {
			super(...e), this._trend = new ki(this, () => []);
		}
		hasDetail() {
		...
		updated() {
			...
			if (this.currentSize === "2x2" && e && this.hass?.connected) {
				let t = this.hass;
				this._trend.load(e, async () => (await vi(t, e, 24)).map((e) => e.value));
			}
		}
		_num(e) {
      ...
      >
        ...
        <div class="stats">
          ${n == null ? x : y`<hd-status-badge tone="eco" icon="mdi:solar-power-variant" text=${`${this._powerText(n).value} ${this._powerText(n).unit} now`}></hd-status-badge>`}
          ${r == null ? x : y`<hd-status-badge tone="eco" icon="mdi:weather-sunny" text=${`${I(r)} kWh today`}></hd-status-badge>`}
          ${a != null && n == null ? y`<hd-status-badge tone="neutral" icon="mdi:chart-bell-curve" text=${`${I(a)} kWh left`}></hd-status-badge>` : x}
          ${i != null && (o === "2x2" || o === "2x1") ? y`<hd-status-badge tone="neutral" icon="mdi:chart-line" text=${`${I(i)} kWh forecast`}></hd-status-badge>` : x}
        </div>

        ${o === "2x2" && this._trend.value.length > 1 ? y`<div class="trend">
...
function bo(e) {
	let t = e.grid ?? 0, n = yo(e.solar ?? 0), r = yo(e.car ?? 0), i = e.carActive ? r : 0, a = yo(t), o = yo(-t), s = yo(n + t - i), c = a > 25 || o > 25, l = n > 25, u = e.carActive && i > 25, d = a > 25 ? "import" : o > 25 ? "export" : "idle", f = {
		watts: d === "export" ? o : a,
...
var Co = t((() => {})), wo = /* @__PURE__ */ n({
	HdFlowDiagram: () => Fo,
	PowerflowWidget: () => Io,
	buildFlowModel: () => To
});
function To(e, t) {
	let n = (t) => t ? vo(e.states[t]) : null, r = n(t.gridPower), i = n(t.solarPower), a = n(t.carPower);
	if ((a == null || a === 0) && t.carPowerAlt) {
		let e = n(t.carPowerAlt);
		e != null && e > 0 && (a = e);
	}
	let o = t.carActive ? e.states[t.carActive]?.state : void 0, s = t.carActiveAlt ? e.states[t.carActiveAlt]?.state : void 0, c = xo(o) || xo(s), l = So(o) || So(s);
	return bo({
		grid: r,
		solar: i,
		car: a,
...
function Eo(e) {
	let t = Math.abs(e);
	return t >= 1e3 ? `${I(t / 1e3)} kW` : `${Math.round(t)} W`;
}
function Do(e, t) {
...
function Oo(e, t, n, r, i) {
	let [a, o] = Do(t[0] - e[0], t[1] - e[1]), s = [e[0] + a * r, e[1] + o * r], [c, l] = Do(t[0] - n[0], t[1] - n[1]), u = [n[0] + c * i, n[1] + l * i], d = `M ${s[0].toFixed(2)} ${s[1].toFixed(2)} Q ${t[0]} ${t[1]} ${u[0].toFixed(2)} ${u[1].toFixed(2)}`, [f, p] = Do(u[0] - t[0], u[1] - t[1]), m = 3.1, h = [u[0] - f * m, u[1] - p * m], ee = -p * m * .6, te = f * m * .6;
	return {
		d,
		chevron: `${u[0].toFixed(2)},${u[1].toFixed(2)} ${(h[0] + ee).toFixed(2)},${(h[1] + te).toFixed(2)} ${(h[0] - ee).toFixed(2)},${(h[1] - te).toFixed(2)}`
	};
}
var ko, J, Ao, jo, Mo, No, Po, Fo, Io, Lo = t((() => {
	C(), E(), O(), G(), Co(), R(), U(), V(), B(), J = {
		grid: [25, 26],
		solar: [75, 26],
		house: [50, 50],
		car: [50, 80]
		...
		solar: [60, 40],
		car: [67, 64]
	}, jo = 10, Mo = 13, No = (e, t, n) => e + (t - e) * n, Po = (e) => 1 - (1 - e) ** 3, Fo = (ko = class extends S {
		constructor(...e) {
			super(...e), this._shown = {
				grid: 0,
				solar: 0,
		...
		_retween() {
			...
			let i = (e) => {
				let a = Math.min(1, (e - r) / 420), o = Po(a);
				this._shown = {
      ...
      ${n ? Pe`<path class="flow" d=${e.d} style=${`stroke:${r};animation-duration:${this._speed(i)}s`}></path>` : x}
      <polygon class="chevron ${n ? "on" : ""}" points=${e.chevron} style=${`fill:${r}`}></polygon>
    `;
		}
		_node(e, t, n, r, i, a) {
			let [o, s] = J[e], c = e === "house";
			return y`<div class="${`node ${c ? "hub " : ""}${r ? "active" : "idle"}`}" style=${`left:${o}%;top:${s}%;--n-fg:${i}`}>
      <div class="disc"><hd-icon .icon=${t} .size=${c ? 26 : 22}></hd-icon></div>
      <div class="label">${Eo(this._shown[e])}</div>
      ${a ?? y`<div class="name">${n}</div>`}
    </div>`;
		}
		render() {
			let e = this.model;
			if (!e) return x;
			let t = "var(--state-eco)", n = "var(--accent)", r = e.grid.mode !== "export", i = e.grid.mode === "export" ? t : n, a = e.paths.houseCar.source === "solar" ? t : n, o = r ? Oo(J.grid, Ao.grid, J.house, jo, Mo) : Oo(J.house, Ao.grid, J.grid, Mo, jo), s = Oo(J.grid, Ao.grid, J.house, jo, Mo), c = Oo(J.solar, Ao.solar, J.house, jo, Mo), l = Oo(J.house, Ao.car, J.car, Mo, jo), u = e.grid.mode === "export" ? t : e.grid.mode === "import" ? n : "var(--text-tertiary)", d = e.grid.mode === "export" ? `Exporting ${Eo(e.grid.watts)}` : e.grid.mode === "import" ? `Importing ${Eo(e.grid.watts)}` : "Grid balanced", f = e.solar.watts > 25;
			return y`
      <div class="stage">
        ...
        ${this._node("house", "mdi:home-variant", "House", e.house.active, "var(--text-primary)", f ? y`<div class="autarky">${e.selfSufficiency}% solar</div>` : y`<div class="name">House</div>`)}
      </div>
    `;
		}
	}, ko.styles = l`
  ...
  `, ko), z([w({ attribute: !1 })], Fo.prototype, "model", void 0), z([T()], Fo.prototype, "_shown", void 0), Fo = z([D("hd-flow-diagram")], Fo), Io = class extends W {
		get _opts() {
	...
	}, Io = z([D("hd-widget-powerflow")], Io);
})), Ro = /* @__PURE__ */ n({
	SolarChargingWidget: () => Wo,
	buildSolarChargingModel: () => zo
});
function zo(e, t) {
	let n = Uo(e, t.master) === "on", r = Uo(e, t.vehicleConnected) === "on", i = Uo(e, t.chargingState), a = Ho(e, t.chargePower), o = Ho(e, t.battery), s = Ho(e, t.chargeLimit), c = Ho(e, t.sessionEnergy), l = Ho(e, t.chargeRate), u = Ho(e, t.chargeCurrent), d = i === "charging" || i === "starting" || (a ?? 0) > .1, f = i === "complete", p;
...
var Bo, Vo, Ho, Uo, Wo, Go = t((() => {
	C(), O(), G(), F(), R(), Ur(), U(), Oi(), V(), B(), Vo = "#E82127", Ho = (e, t) => {
		if (!t || !e) return null;
		let n = e.states[t];
		if (!n) return null;
		let r = Number(n.state);
		return Number.isFinite(r) ? r : null;
	}, Uo = (e, t) => t ? e?.states[t]?.state : void 0, Wo = (Bo = class extends W {
		get _opts() {
		...
		_toggleMaster() {
			...
			e && this.callService(N(e), { errorVerb: "toggle solar charging" });
		}
		_renderHero(e) {
			let t = e.batteryPct, n = e.limitPct, r = e.phase === "charging", i = [];
			e.rateKmh != null && e.rateKmh > .5 && i.push(`${Math.round(e.rateKmh)} km/h`), e.sessionKwh != null && e.sessionKwh > .01 && i.push(`${I(e.sessionKwh)} kWh session`);
			let a = t == null ? x : y`<div class="hbattery">
            <div class="brow">
            ...
            <div class="btrack">
              ...
              ${n == null ? x : y`<div class="blimit" style=${`left:${Math.min(100, Math.max(0, n))}%`}></div>`}
            </div>
          </div>`;
			return y`
      <hd-widget-frame
      ...
      >
        <div class="hero" ?data-charging=${r && e.armed}>
          ...
          <img
            class="car"
            src=${Hr("assets/tesla-model-3.webp")}
            alt=""
            aria-hidden="true"
            draggable="false"
          />
          <div class="top">
            ...
            <div class="htext">
              ...
              ${i.length ? y`<span class="hstatus">${i.join(" · ")}</span>` : x}
            </div>
          </div>
          <div class="bottom">
            ${a}
    ...
    `;
		...
		renderContent() {
			let e = zo(this.hass, this._opts), t = this.currentSize;
      ...
      <hd-widget-frame
        ...
        @hd-activate=${() => this.openDetail()}
      >
        ${a ? y`<div class="battery">
              <div class="line">
                <span class="soc">${Math.round(n)}%</span>
                ${r == null ? x : y`<span>Target ${Math.round(r)}%</span>`}
              </div>
              <div class="bar" style=${`--fill:${i}`}>
                <div class="fill" style=${`width:${Math.min(100, Math.max(0, n))}%`}></div>
                ${r == null ? x : y`<div class="limit" style=${`left:${Math.min(100, Math.max(0, r))}%`}></div>`}
              </div>
            </div>` : x}
        ${o ? y`<div class="stats">
              ${e.powerKw != null && e.powerKw > .05 ? y`<hd-status-badge
                    tone=${e.armed ? "eco" : "accent"}
                    icon="mdi:flash"
                    text=${`${I(e.powerKw)} kW`}
                  ></hd-status-badge>` : x}
              ${e.sessionKwh != null && e.sessionKwh > .01 ? y`<hd-status-badge
                    tone="neutral"
                    icon="mdi:counter"
                    text=${`${I(e.sessionKwh)} kWh session`}
                  ></hd-status-badge>` : x}
              ${e.rateKmh != null && e.rateKmh > .5 ? y`<hd-status-badge
                    tone="neutral"
  ...
  `, Bo), Wo = z([D("hd-widget-solarcharging")], Wo);
}));
//#endregion
...
function qo(e, t, n = /* @__PURE__ */ new Date()) {
	let r = new Date(n);
...
async function Yo(e, t, n, r) {
	...
	return i.length ? Ko(await e.callWS({
...
var Xo = t((() => {})), Zo, Qo, $o, es, ts = t((() => {
	C(), E(), O(), B(), Qo = (e) => {
		if (e <= 0) return 1;
		let t = 10 ** Math.floor(Math.log10(e)), n = e / t;
		return (n <= 1 ? 1 : n <= 2 ? 2 : n <= 5 ? 5 : 10) * t;
	}, $o = (e) => Math.abs(e) >= 100 ? Math.round(e).toString() : e.toFixed(1), es = (Zo = class extends S {
		constructor(...e) {
		...
		render() {
			...
			if (!e || !t.length || n <= 0) return y`<div class="empty">No data for this period</div>`;
			let r = Qo(n), i = t.map((e) => `${e.label} ${$o(this._total(e))} ${this.unit}`).join(", ");
			return y`
      <div class="wrap" role="img" aria-label=${i}>
        <div class="plot">
          <span class="ymax">${$o(r)} ${this.unit}</span>
          ${this.labels.map((e, t) => y`<div class="group">
              <div class="bars">
                ${this.series.map((e) => {
        ...
        ${this.legend ? y`<div class="legend">
              ${this.series.map((e) => y`<span class="key" style=${`--c:${e.color}`}>
                  <i></i>${e.label} <b>${$o(this._total(e))} ${this.unit}</b>
                </span>`)}
            </div>` : x}
      </div>
    `;
  ...
  `, Zo), z([w({ attribute: !1 })], es.prototype, "series", void 0), z([w({ attribute: !1 })], es.prototype, "labels", void 0), z([w({ type: String })], es.prototype, "unit", void 0), z([w({ type: Boolean })], es.prototype, "legend", void 0), es = z([D("hd-bar-chart")], es);
})), ns = /* @__PURE__ */ n({ EnergyChartWidget: () => os }), rs, is, as, os, ss = t((() => {
	C(), E(), O(), G(), Xo(), U(), ts(), br(), Ai(), B(), is = [
		{
			key: "solar",
			label: "Solar",
			color: "#f4b740"
		...
		week: 8,
		month: 12
	}, os = (rs = class extends W {
		constructor(...e) {
			super(...e), this._period = "day", this._periodInit = !1, this._data = new ki(this, () => ({}));
		}
		get _opts() {
		...
		_ids() {
			return is.map((e) => this._opts[e.key]).filter((e) => typeof e == "string");
		}
		updated() {
		...
		_chart() {
			let e = as[this._period], t = /* @__PURE__ */ new Set();
			for (let e of is) {
				let n = this._opts[e.key];
				if (n) for (let e of this._data.value[n] ?? []) t.add(e.start);
			}
			let n = [...t].sort((e, t) => e - t).slice(-e);
			return {
				labels: n.map((e) => Jo(e, this._period)),
				series: is.filter((e) => this._opts[e.key]).map((e) => {
					let t = new Map((this._data.value[this._opts[e.key]] ?? []).map((e) => [e.start, e.change]));
					return {
						label: e.label,
						color: e.color,
  ...
  `, rs), z([T()], os.prototype, "_period", void 0), z([T()], os.prototype, "_periodInit", void 0), os = z([D("hd-widget-energychart")], os);
})), cs = /* @__PURE__ */ n({ MetricTileWidget: () => us }), ls, us, ds = t((() => {
	C(), O(), G(), $n(), Co(), R(), V(), B(), us = (ls = class extends W {
		get _opts() {
		...
		_valueText() {
			...
			if (e.format === "power") {
				...
				if (e == null) return "—";
				let n = Math.abs(e);
				return n >= 1e3 ? `${I(n / 1e3)} kW` : `${Math.round(n)} W`;
			}
			if (e.format === "percent") {
				let e = Number(t.state);
				return Number.isFinite(e) ? `${Math.round(e)}%` : "—";
			}
			return bn(this.hass, t);
		}
		_statusText() {
			let e = this._opts;
			if (e.status === "gridDirection") {
				let e = this.entityId ? this.hass?.states[this.entityId] : void 0, t = e ? vo(e) : null;
			...
			if (e.status === "carCharge") {
				...
				return (e.connected ? this.hass?.states[e.connected]?.state : void 0) === "on" || So(t) ? xo(t) ? "Charging" : "Plugged in" : "Disconnected";
			}
			return "";
		}
		renderContent() {
			let e = this._opts, t = Xn(e.accent ?? "idle").fg, n = this.entityId ? this.hass?.states[this.entityId] : void 0, r = !n || n.state === "unavailable" || n.state === "unknown";
  ...
  `, ls), us = z([D("hd-widget-metrictile")], us);
})), fs = /* @__PURE__ */ n({ ElectricityTotalWidget: () => ms }), ps, ms, hs = t((() => {
	C(), E(), O(), G(), Xo(), R(), B(), ms = (ps = class extends W {
		constructor(...e) {
		...
		async _fetch() {
			...
			if (n.length) try {
				let r = await Yo(this.hass, n, "day", qo("day", 1));
				this._import = e ? this._sum(r[e]) : 0, this._export = t ? this._sum(r[t]) : 0, this._ready = !0;
			} catch {}
		}
		_term(e, t, n, r) {
			return y`<div class="term">
      <span class="num" style=${`--n:${r}`}><b>${I(e)}</b><span class="u">${t}</span></span>
  ...
  `, ps), z([T()], ms.prototype, "_import", void 0), z([T()], ms.prototype, "_export", void 0), z([T()], ms.prototype, "_ready", void 0), ms = z([D("hd-widget-electricitytotal")], ms);
}));
//#endregion
...
function _s(e) {
	...
	return t.forEach((e, t) => {
		...
		(typeof r.entity != "string" || !ks.test(r.entity)) && n.push({
...
function ys(e) {
	...
	}), t.data !== void 0 && !Y(t.data) && n.push({
		path: "data",
		message: "Action `data` must be an object."
	}), t.target !== void 0 && !Y(t.target) && n.push({
		path: "target",
		message: "Action `target` must be an object."
	}), n;
}
function bs(e) {
	return typeof e == "string" ? ks.test(e) ? [e] : [] : Array.isArray(e) ? e.flatMap(bs) : !e || typeof e != "object" ? [] : Object.values(e).flatMap(bs);
}
function xs(e) {
	let t = e.entity ? [e.entity] : [];
	return e.type === "action" ? t : (t.push(...bs(e.options)), [...new Set(t)]);
}
function Ss(e, t, n) {
	if (e === void 0) return [];
	if (!Y(e)) return [{
	...
	for (let i of n) {
		let n = e[i];
		n !== void 0 && (typeof n != "string" || !ks.test(n)) && r.push({
			path: i,
...
function Cs(e) {
	if (!Y(e)) return [{
		path: "",
		message: "Group options must be an object."
	}];
	let t = e, n = [];
	return t.label !== void 0 && typeof t.label != "string" && n.push({
		path: "label",
		message: "Group `label` must be a string."
	}), t.variant !== void 0 && !xt.includes(t.variant) && n.push({
		path: "variant",
		message: `Group \`variant\` must be one of: ${xt.join(", ")}.`
	}), (!Array.isArray(t.children) || t.children.length === 0) && n.push({
		path: "children",
		message: "Group `children` must be a non-empty array."
	}), n;
}
function ws(e) {
	let t = Ss(e, "Metric tile", ["chargeStatus", "connected"]);
	if (!Y(e)) return t;
	let n = e;
...
function Ts(e) {
	let t = Ss(e, "Solar charging", As);
	return Y(e) ? (e.brand !== void 0 && e.brand !== "tesla" && t.push({
		path: "brand",
...
function Es(e) {
	let t = Ss(e, "Energy chart", [
		"gridImport",
		"gridExport",
		"solar",
		"car"
	]);
	return Y(e) && e.defaultPeriod !== void 0 && ![
		"day",
		"week",
		"month"
...
function Os(e) {
	return rc[e.type].dependencyIds(e);
}
var ks, As, js, Ms, Ns, Ps, Fs, Is, Ls, Rs, zs, Bs, Vs, Hs, Us, Ws, Gs, Ks, qs, Js, Ys, Xs, Zs, Qs, $s, ec, tc, nc, rc, ic = t((() => {
	St(), ks = /^[a-z_]+\.[a-z0-9_]+$/, As = [
		"master",
		"vehicleConnected",
		"chargingState",
		"wallStatus",
		...
		label: "Light",
		icon: "mdi:lightbulb",
		load: () => Promise.resolve().then(() => (hr(), fr)),
		supportedSizes: [
			"1x1",
			"2x1",
			"1x2",
		...
		label: "Climate",
		icon: "mdi:thermostat",
		load: () => Promise.resolve().then(() => (Tr(), xr)),
		supportedSizes: [
			"2x1",
			"1x2",
			"2x2"
		...
		quickAction: "none",
		hasDetail: !0,
		dependencyIds: (e) => [...e.entity ? [e.entity] : [], ...gs(e.options).map((e) => e.entity)],
		validateOptions: _s,
		...
		load: () => Promise.resolve().then(() => (Ar(), Or)),
		...
		label: "Fan",
		icon: "mdi:fan",
		load: () => Promise.resolve().then(() => (Pr(), jr)),
		supportedSizes: [
			"1x1",
			"2x1",
			"1x2"
		...
		label: "Cover",
		icon: "mdi:window-shutter",
		load: () => Promise.resolve().then(() => (Rr(), Fr)),
		supportedSizes: [
			"1x1",
			"2x1",
			"1x2",
		...
		label: "Lock",
		icon: "mdi:lock",
		load: () => Promise.resolve().then(() => (Vr(), zr)),
		supportedSizes: ["1x1", "2x1"],
		defaultSize: {
			compact: "1x1",
			medium: "1x1",
		...
		load: () => Promise.resolve().then(() => (qr(), Wr)),
		supportedSizes: [
			"1x1",
			"2x1",
			"2x2"
		...
		label: "Media",
		icon: "mdi:cast",
		load: () => Promise.resolve().then(() => (_i(), fi)),
		...
		label: "Sensor",
		icon: "mdi:gauge",
		load: () => Promise.resolve().then(() => (Fi(), ji)),
		supportedSizes: [
			"1x1",
			"2x1",
			"1x2",
		...
		load: () => Promise.resolve().then(() => (zi(), Ii)),
		supportedSizes: [
			"2x1",
			"1x2",
			"2x2"
		...
		load: () => Promise.resolve().then(() => (Hi(), Bi)),
		supportedSizes: ["1x1", "2x1"],
		defaultSize: {
			compact: "1x1",
			medium: "1x1",
		...
		label: "Person",
		icon: "mdi:account",
		load: () => Promise.resolve().then(() => (Gi(), Ui)),
		supportedSizes: ["1x1", "2x1"],
		defaultSize: {
			compact: "1x1",
			medium: "1x1",
		...
		label: "Camera",
		icon: "mdi:cctv",
		load: () => Promise.resolve().then(() => (Yi(), Ki)),
		supportedSizes: ["2x1", "2x2"],
		defaultSize: {
			compact: "2x1",
			medium: "2x1",
		...
		load: () => Promise.resolve().then(() => (ea(), Qi)),
		supportedSizes: [
			"1x1",
			"2x1",
			"1x2"
		...
		load: () => Promise.resolve().then(() => (ra(), ta)),
		supportedSizes: ["1x1", "2x1"],
		defaultSize: {
			compact: "1x1",
			medium: "1x1",
		...
		load: () => Promise.resolve().then(() => (oa(), ia)),
		supportedSizes: ["1x1", "2x1"],
		defaultSize: {
			compact: "1x1",
			medium: "1x1",
		...
		load: () => Promise.resolve().then(() => (ua(), sa)),
		supportedSizes: [
			"1x1",
			"2x1",
			"2x2"
		...
		label: "Action",
		icon: "mdi:gesture-tap-button",
		load: () => Promise.resolve().then(() => (pa(), da)),
		supportedSizes: ["1x1", "2x1"],
		defaultSize: {
			compact: "1x1",
			medium: "1x1",
		...
		load: () => Promise.resolve().then(() => (po(), lo)),
		supportedSizes: vt,
		defaultSize: {
			compact: "4x2",
			medium: "4x2",
		...
		label: "Energy",
		icon: "mdi:lightning-bolt-outline",
		load: () => Promise.resolve().then(() => (_o(), mo)),
		supportedSizes: [
			"2x1",
			"1x2",
			"2x2"
		...
		label: "Power flow",
		icon: "mdi:transmission-tower",
		load: () => Promise.resolve().then(() => (Lo(), wo)),
		...
		hasDetail: !0,
		dependencyIds: (e) => xs(e),
		validateOptions: (e) => Ss(e, "Power flow", [
			"gridPower",
			"solarPower",
			"houseConsumption",
			"carPower",
		...
		icon: "mdi:car-electric",
		load: () => Promise.resolve().then(() => (Go(), Ro)),
		supportedSizes: [
			"2x1",
			"1x2",
			"2x2"
		...
		label: "Energy chart",
		icon: "mdi:chart-bar",
		load: () => Promise.resolve().then(() => (ss(), ns)),
		...
		label: "Metric tile",
		icon: "mdi:gauge",
		load: () => Promise.resolve().then(() => (ds(), cs)),
		supportedSizes: ["1x1", "2x1"],
		defaultSize: {
			compact: "1x1",
			medium: "1x1",
		...
		icon: "mdi:flash",
		load: () => Promise.resolve().then(() => (hs(), fs)),
		supportedSizes: ["2x2", "4x2"],
		defaultSize: {
			compact: "2x2",
			medium: "4x2",
		...
		hasDetail: !1,
		dependencyIds: (e) => xs(e),
		validateOptions: (e) => Ss(e, "Electricity total", ["importEnergy", "exportEnergy"])
	}, nc = {
		light: js,
		climate: Ms,
		switch: Ns,
...
function ac(e) {
	return typeof e == "string" && lc.test(e);
}
function oc(e) {
...
function sc(e) {
	...
	for (let t = 0; t < (e.views ?? []).length; t++) {
		...
		for (let e = 0; e < (s.widgets ?? []).length; e++) {
			let t = s.widgets[e], r = cc(t, `${c}.widgets[${e}]`, a, n);
			r && l.push(r);
		}
		o.push({
			...s,
...
function cc(e, t, n, r) {
	...
	if (n.add(e.id), !bt.includes(e.type)) return r(`${t}.type`, `Unknown widget type "${e.type}".`), null;
	let i = e.type, a = Ds(i), o = !0;
	if (a.requiresEntity && !e.entity ? (r(`${t}.entity`, `Widget "${e.id}" (${i}) requires an \`entity\`.`), o = !1) : e.entity && !ac(e.entity) && (r(`${t}.entity`, `"${e.entity}" is not a valid entity_id (expected e.g. light.living_room).`), o = !1), !e.size || typeof e.size != "object") r(`${t}.size`, `Widget "${e.id}" is missing a size set.`), o = !1;
	else {
	...
	if (e.type === "group") {
		...
		if (!Array.isArray(i) || i.length === 0) r(`${t}.options.children`, `Group "${e.id}" must have a non-empty \`children\` array.`), o = !1;
			...
			let a = i.map((e, i) => cc(e, `${t}.options.children[${i}]`, n, r)).filter((e) => e !== null);
...
var lc, uc = t((() => {
	St(), ic(), lc = /^[a-z_]+\.[a-z0-9_]+$/;
}));
//#endregion
//#region src/panel/router.ts
function dc(e, t, n = window.location) {
	return e && typeof e.path == "string" ? pc(e.path) : fc(n.pathname, t);
}
function fc(e, t) {
...
var gc, X = (gc = class extends S {
	...
	render() {
      ...
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-label=${this.heading ? x : "Details"}
        aria-labelledby=${e ?? x}
        tabindex="-1"
      >
        <div
        ...
        ${this.headless ? x : y`
              <header>
                <div class="titles">
                  ...
                  ${this.subheading ? y`<p>${this.subheading}</p>` : x}
                </div>
                <hd-icon-button
                  icon="mdi:close"
                  label="Close"
...
z([w({
	type: Boolean,
	reflect: !0
})], X.prototype, "open", void 0), z([w({ type: String })], X.prototype, "variant", void 0), z([w({ type: String })], X.prototype, "heading", void 0), z([w({ type: String })], X.prototype, "subheading", void 0), z([w({ type: Boolean })], X.prototype, "headless", void 0), z([T()], X.prototype, "_resolved", void 0), z([T()], X.prototype, "_dragY", void 0), z([T()], X.prototype, "_closing", void 0), z([lt(".container")], X.prototype, "_container", void 0), X = z([D("hd-surface")], X), C(), E(), O(), co(), V(), _r(), B();
var _c, vc = (e) => e >= 1e3 ? "sidebar" : e >= 720 ? "rail" : "compact", Z = (_c = class extends S {
	constructor(...e) {
		super(...e), this.views = [], this.currentViewId = "", this.productTitle = "Home", this.subtitle = "", this.connected = !0, this.appearance = "auto", this._switcherOpen = !1, this._responsive = new so(this, vc);
	}
	get _mode() {
	...
	_renderNav() {
		let e = this.views.filter((e) => e.type === "room"), t = this.views.filter((e) => e.type !== "room"), n = (e) => y`
      <button
        class="navitem"
    ...
    `;
      ...
      <nav class="side" aria-label="Views">
        ...
        ${e.length ? y`<div class="navsection">Rooms</div>` : x}
        ${e.map(n)}
        ${t.filter((e) => e.type === "system").length ? y`<div class="navsection">System</div>` : x}
	...
	render() {
      ...
      <div class="shell" data-mode=${this._mode}>
        ...
        <div class="main">
          <header class="topbar">
            ${t ? y`<button class="switcher" @click=${() => this._switcherOpen = !0} aria-haspopup="dialog">
                    <span class="cur">
                  ...
                  </button>` : y`<div class="titles">
                    <h1>${e?.label ?? this.productTitle}</h1>
                    ${this.subtitle ? y`<p>${this.subtitle}</p>` : x}
                  </div>`}
            <div class="actions">
              ${this.connected ? x : y`<hd-icon title="Offline" icon="mdi:wifi-off" .size=${20} style="color:var(--state-warn)"></hd-icon>`}
              ${t ? y`<hd-icon-button
          ...
          ${this.connected ? x : y`<div class="offline" role="status">
  ...
  `, _c);
z([w({ attribute: !1 })], Z.prototype, "views", void 0), z([w({ type: String })], Z.prototype, "currentViewId", void 0), z([w({ type: String })], Z.prototype, "productTitle", void 0), z([w({ type: String })], Z.prototype, "subtitle", void 0), z([w({ type: Boolean })], Z.prototype, "connected", void 0), z([w({ type: String })], Z.prototype, "appearance", void 0), z([T()], Z.prototype, "_switcherOpen", void 0), Z = z([D("hd-app-shell")], Z), po(), C(), E(), ja(), O(), Co(), R(), Ur(), V(), B();
var yc, bc = 960, xc = 720;
function Sc(e, t) {
	if (!e || !t) return [];
	let n = (t) => t ? vo(e.states[t]) : null, r = n(t.gridPower) ?? 0, i = n(t.solarPower) ?? 0, a = n(t.carPower) ?? 0, o = t.carConnected ? e.states[t.carConnected]?.state === "on" : !1, s = i + r - a, c = [];
...
var Cc = (yc = class extends S {
	...
	_stat(e, t) {
		return y`<div class="stat">
      <span class="v">${e == null ? "—" : I(e)}<span class="u">kWh</span></span>
      <span class="l">${t}</span>
    </div>`;
	}
	render() {
		let e = this.options, t = this._num(e?.solar), n = this._num(e?.grid), r = n != null && t != null ? n + t : null, i = Sc(this.hass, e);
		return y`
      <div class="hero">
        <div class="inner">
          <div class="bar">
          ...
          <div class="house">
            <img
              class="house-art"
              src=${Hr("assets/energy-house.webp")}
              alt=""
              aria-hidden="true"
            />
            ${ka(i, (e) => e, (e) => y`
                <img
                  class="flow"
                  src=${Hr(`assets/energy-flows/${e}${this._reduce ? "-still" : ""}.webp`)}
                  alt=""
                  aria-hidden="true"
                  decoding="async"
                />
  ...
  `, yc);
z([w({ attribute: !1 })], Cc.prototype, "hass", void 0), z([w({ attribute: !1 })], Cc.prototype, "options", void 0), Cc = z([D("hd-energy-hero")], Cc), C(), E(), ja(), O(), Ga(), oo(), co(), V(), U(), B();
var wc, Tc = (wc = class extends S {
	constructor(...e) {
		super(...e), this._responsive = new so(this, Ma);
	}
	render() {
		let e = this.view, t = this._responsive.profile, n = `--pad:${t.pad}px`, r = e?.hero ? y`<hd-energy-hero .hass=${this.hass} .options=${e.hero}></hd-energy-hero>` : x;
		if (!e || e.widgets.length === 0 && !e.hero) return y`<div class="empty">
      ...
      <div class="stack" style=${n}>
        ${ka(i, (e) => e.id, (e) => io(e, Na(e, t.bucket), 1, this.hass, "row"))}
      </div>
      ${x}
    `;
	}
  ...
  `, wc);
z([w({ attribute: !1 })], Tc.prototype, "hass", void 0), z([w({ attribute: !1 })], Tc.prototype, "view", void 0), Tc = z([D("hd-view-grid")], Tc);
//#endregion
...
function Oc(e, t) {
	let n = Ot(t), r = t.state === "off", i = t.attributes.temperature ?? 20, a = t.attributes.current_temperature, o = t.attributes.target_temp_step ?? .5, s = t.attributes.hvac_modes ?? [], c = t.attributes.fan_modes ?? [], l = t.attributes.swing_modes ?? [], u = t.attributes.preset_modes ?? [], d = (e.config?.type === "climate" ? e.config.options?.switches ?? [] : []).filter((t) => e.hass.states[t.entity]), f = (n) => {
		...
		e.call(Ut(e.entityId, Number(s.toFixed(1))), "set temperature for");
	}, p = (e) => e.map((e) => ({
		value: e,
		label: L(e)
	}));
	return y`
    ${n.targetTemp ? y`<div class="d-section climate-hero">
          <hd-icon-button
            icon="mdi:minus"
            label="Lower"
            variant="soft"
          ...
          <div class="climate-target">
            <span class="big">${r ? "—" : `${I(i)}°`}</span>
            ${a == null ? x : y`<span class="sub">Now ${I(a)}°</span>`}
          </div>
          <hd-icon-button
            icon="mdi:plus"
            label="Raise"
    ...
    ${s.length > 1 ? y`<div class="d-section">
          <span class="d-label">Mode</span>
          <hd-segmented
            .options=${p(s)}
            .value=${t.state}
            label="Mode"
            @hd-select=${(t) => e.call(Wt(e.entityId, t.detail.value), "set mode for")}
          ></hd-segmented>
        </div>` : x}
    ${n.fanMode && c.length ? y`<div class="d-section">
          <span class="d-label">Fan</span>
          <hd-segmented
            .options=${p(c)}
            .value=${t.attributes.fan_mode ?? ""}
            label="Fan mode"
            @hd-select=${(t) => e.call(Gt(e.entityId, t.detail.value), "set fan for")}
          ></hd-segmented>
        </div>` : x}
    ${n.swingMode && l.length ? y`<div class="d-section">
          <span class="d-label">Swing</span>
          <hd-segmented
            .options=${p(l)}
            .value=${t.attributes.swing_mode ?? ""}
            label="Swing mode"
            @hd-select=${(t) => e.call(qt(e.entityId, t.detail.value), "set swing for")}
          ></hd-segmented>
        </div>` : x}
    ${n.presetMode && u.length ? y`<div class="d-section">
          <span class="d-label">Preset</span>
          <hd-segmented
            .options=${p(u)}
            .value=${t.attributes.preset_mode ?? ""}
            label="Preset"
            @hd-select=${(t) => e.call(Kt(e.entityId, t.detail.value), "set preset for")}
          ></hd-segmented>
        </div>` : x}

    ${d.map((t) => {
		let n = e.hass.states[t.entity].state === "on";
		return y`<div class="d-section d-row-between">
        <span class="d-label">${t.name}</span>
        <hd-toggle
          .checked=${n}
          label=${t.name}
          @hd-toggle=${() => e.call(N(t.entity), `toggle ${t.name.toLowerCase()}`)}
        ></hd-toggle>
      </div>`;
	})}
  `;
...
function kc(e, t) {
	...
	return y`<div class="d-grid">
    ${n.map((n) => y`<div class="d-cell">
      <span class="k">${L(n)}</span>
      <span class="v">${xn(e.hass, t, n)}</span>
    </div>`)}
    <div class="d-cell">
      <span class="k">Last updated</span>
      <span class="v">${Cn(t.last_updated)}</span>
    </div>
  </div>`;
}
C(), M(), F(), R(), jn(), nr();
function Ac(e, t) {
	let n = Dt(t), r = t.attributes.current_position ?? (t.state === "open" ? 100 : 0);
	return y`
    ${n.setPosition ? y`<div class="d-section">
          <span class="d-label">Position</span>
          <hd-slider
            .value=${r}
            .valueText=${`${Math.round(r)}% open`}
            label="Position"
            @hd-change=${(t) => e.call(Zt(e.entityId, t.detail.value), "move")}
          ></hd-slider>
        </div>` : x}
    <div class="d-section big-buttons">
      ${n.open ? y`<button
            class="bigbtn"
            @click=${() => e.call(Jt(e.entityId), "open")}
          ><hd-icon icon="mdi:arrow-up" .size=${20}></hd-icon>Open</button>` : x}
      ${n.stop ? y`<button
            class="bigbtn"
            @click=${() => e.call(Xt(e.entityId), "stop")}
          ><hd-icon icon="mdi:stop" .size=${20}></hd-icon>Stop</button>` : x}
      ${n.close ? y`<button
            class="bigbtn"
            @click=${() => e.call(Yt(e.entityId), "close")}
          ><hd-icon icon="mdi:arrow-down" .size=${20}></hd-icon>Close</button>` : x}
    </div>
  `;
}
function jc(e, t) {
    ...
    <div class="d-section big-buttons">
      <button
        ...
        @click=${() => e.call(dn(e.entityId), "lock")}
      >
      ...
      <button class="bigbtn ${n ? "" : "active"}" @click=${async () => {
		...
		}) && e.call(fn(e.entityId), "unlock");
	}}>
        <hd-icon icon="mdi:lock-open-variant" .size=${20}></hd-icon>Unlock
      </button>
    </div>
    <div class="d-meta">Last changed ${Cn(t.last_changed)}</div>
  `;
}
function Mc(e, t) {
	let n = At(t), r = (t.attributes.fan_speed_list ?? []).filter((e) => !["off", "custom"].includes(e)), i = kn(e.hass, e.entityId), a = i.battery ?? t.attributes.battery_level, o = t.state === "cleaning", s = [];
	return typeof i.progress == "number" && o && s.push(["Progress", `${Math.round(i.progress)}%`]), typeof i.area == "number" && i.area > 0 && s.push(["Area", `${I(i.area)} m²`]), typeof i.cleaningTime == "number" && i.cleaningTime > 0 && s.push(["Time", `${Math.round(i.cleaningTime)} min`]), y`
    <div class="d-section big-buttons">
      <button
        class="bigbtn"
        @click=${() => e.call(on(e.entityId), "start")}
      ><hd-icon icon="mdi:play" .size=${20}></hd-icon>Start</button>
      ${n.pause ? y`<button
            class="bigbtn"
            @click=${() => e.call(sn(e.entityId), "pause")}
          ><hd-icon icon="mdi:pause" .size=${20}></hd-icon>Pause</button>` : x}
      ${n.returnHome ? y`<button
            class="bigbtn"
            @click=${() => e.call(cn(e.entityId), "dock")}
          ><hd-icon icon="mdi:home-import-outline" .size=${20}></hd-icon>Dock</button>` : x}
      ${n.locate ? y`<button
            class="bigbtn"
            @click=${() => e.call(un(e.entityId), "locate")}
          ><hd-icon icon="mdi:map-marker-radius" .size=${20}></hd-icon>Locate</button>` : x}
    </div>
    ${r.length ? y`<div class="d-section">
		...
		label: L(e)
            ...
            @hd-select=${(t) => e.call(ln(e.entityId, t.detail.value), "set suction for")}
          ></hd-segmented>
        </div>` : x}
    ${s.length ? y`<div class="d-section">
          <span class="d-label">${o ? i.room ? `Cleaning ${i.room}` : "Current clean" : "Last clean"}</span>
          <div class="d-grid">
            ${s.map(([e, t]) => y`<div class="d-cell">
              <span class="k">${e}</span><span class="v">${t}</span>
            </div>`)}
          </div>
        </div>` : x}
    ${i.consumables.length ? y`<div class="d-section">
          <span class="d-label">Consumables</span>
          <div class="d-grid">
            ${i.consumables.map((e) => {
		let t = e.hoursLeft <= 20;
		return y`<div class="d-cell">
    ...
    ${a == null ? x : y`<div class="d-meta">Battery ${Math.round(a)}%${i.status ? ` · ${L(i.status.replace(/_/g, " "))}` : ""}</div>`}
  `;
}
function Nc(e, t) {
	...
	return y`
    <div class="d-value big">${bn(e.hass, t)}</div>
    ${r ? y`<div class="d-section big-buttons">
          <button
            class="bigbtn"
            @click=${() => e.call(zt(e.entityId), "turn on")}
          >Turn on</button>
          <button
            class="bigbtn"
            @click=${() => e.call(Bt(e.entityId), "turn off")}
          >Turn off</button>
        </div>` : x}
    ${kc(e, t)}
  `;
...
function Ic(e, t) {
	let n = Et(t), r = t.state === "on", i = r ? Math.round((t.attributes.brightness ?? 255) / 2.55) : 0, a = t.attributes.min_color_temp_kelvin ?? 2200, o = t.attributes.max_color_temp_kelvin ?? 6500, s = t.attributes.color_temp_kelvin ?? Math.round((a + o) / 2), c = t.attributes.effect_list?.filter((e) => e && e !== "None") ?? [], l = t.attributes.hs_color, u = t.attributes.rgb_color, [d, f] = l ? [l[0], l[1]] : u ? Fc(u) : [0, 0];
	return y`
    <div class="d-section d-row-between">
      ...
      <hd-toggle
        .checked=${r}
        label="Toggle light"
        @hd-toggle=${() => e.call(N(e.entityId), "toggle")}
      ></hd-toggle>
    </div>

    ${n.brightness ? y`<div class="d-section">
          ...
          <hd-slider
            ...
            icon="mdi:brightness-6"
            label="Brightness"
            @hd-change=${(t) => e.call(Ht(e.entityId, t.detail.value), "dim")}
          ></hd-slider>
        </div>` : x}

    ${n.colorTemp ? y`<div class="d-section">
          ...
          <hd-slider
            ...
            @hd-change=${(t) => e.call(Vt(e.entityId, { colorTempKelvin: t.detail.value }), "set color of")}
          ></hd-slider>
        </div>` : x}

    ${n.color ? y`<div class="d-section">
          ...
          <div class="color-wheel-wrap">
            <hd-color-wheel
              ...
              .sat=${f}
              .disabled=${!r}
              @hd-color=${(t) => e.call(Vt(e.entityId, { hsColor: [t.detail.hue, t.detail.sat] }), "set color of")}
            ></hd-color-wheel>
          </div>
          <div class="swatches">
            ${Pc.map(([t, n]) => y`<button
                ...
                aria-label=${t}
                ?disabled=${!r}
                @click=${() => e.call(Vt(e.entityId, { rgbColor: n }), "set color of")}
              ></button>`)}
          </div>
        </div>` : x}

    ${n.effects && c.length ? y`<div class="d-section">
          <span class="d-label">Effect</span>
          <div class="chips">
            ${c.slice(0, 12).map((n) => y`<button
                class="chip ${t.attributes.effect === n ? "active" : ""}"
                ?disabled=${!r}
                @click=${() => e.call(Vt(e.entityId, { effect: n }), "set effect of")}
              >
                ${L(n)}
              </button>`)}
          </div>
...
C(), M(), ei(), ni(), F(), R();
function Lc(e, t) {
	let n = kt(t), r = t.attributes.entity_picture, i = t.attributes.media_title, a = t.attributes.app_name, o = t.attributes.volume_level ?? 0, s = t.attributes.is_volume_muted ?? !1, c = t.attributes.source_list ?? [], l = t.attributes.sound_mode_list ?? [], u = t.state === "off", d = n.selectSource && Yr(c), { featured: f, rest: p } = d ? Zr(c) : {
		featured: [],
		rest: c
	}, m = async (t) => {
		u && await e.call(zt(e.entityId), "turn on"), await e.call(rn(e.entityId, t), d ? "launch" : "change source of");
	}, h = !u && t.state !== "idle" && t.state !== "standby", ee = a ? Jr(a) : void 0, te = ti(t);
	return y`
    ${r ? y`<div class="media-art" style=${`background-image:url("${r}")`}></div>` : h && (ee || a) ? y`<div class="media-art media-art-fallback">
            <hd-icon icon=${ee ?? "mdi:television-classic"} .size=${56}></hd-icon>
            ${a ? y`<span>${a}</span>` : x}
          </div>` : x}
    <div class="media-meta">
      <div class="d-value">${i ?? a ?? bn(e.hass, t)}</div>
      ${a && i ? y`<div class="d-sub">${a}</div>` : x}
    </div>
    ${te ? y`<div class="d-section media-progress">
          <div class="media-progress-bar"><span style=${`width:${te.pct}%`}></span></div>
          <div class="media-progress-time">
            <span>${te.elapsed}</span><span>${te.total}</span>
          </div>
        </div>` : x}
    <div class="d-section media-transport">
      ${n.power ? y`<hd-icon-button
            icon="mdi:power"
            label=${u ? "Turn on" : "Turn off"}
            variant=${u ? "soft" : "filled"}
            @click=${() => e.call(N(e.entityId), u ? "turn on" : "turn off")}
          ></hd-icon-button>` : x}
      ${n.previous ? y`<hd-icon-button
            icon="mdi:skip-previous"
            label="Previous"
            variant="soft"
            .disabled=${u}
            @click=${() => e.call(en(e.entityId), "skip")}
          ></hd-icon-button>` : x}
      <hd-icon-button
        ...
        variant="filled"
        .disabled=${u}
        @click=${() => e.call(Qt(e.entityId), "control")}
      ></hd-icon-button>
      ${n.next ? y`<hd-icon-button
            icon="mdi:skip-next"
            label="Next"
            variant="soft"
            .disabled=${u}
    ...
    ${n.volumeSet ? y`<div class="d-section">
          <span class="d-label">Volume</span>
          <div class="vol-row">
            ${n.mute ? y`<hd-icon-button
                  icon=${s ? "mdi:volume-off" : "mdi:volume-high"}
                  label="Mute"
                  variant="soft"
                  @click=${() => e.call(nn(e.entityId, !s), "mute")}
                ></hd-icon-button>` : x}
            <hd-slider
              style="flex:1"
              ...
              label="Volume"
              @hd-change=${(t) => e.call(tn(e.entityId, t.detail.value / 100), "set volume of")}
            ></hd-slider>
          </div>
        </div>` : x}
    ${n.selectSoundMode && l.length ? y`<div class="d-section">
          <span class="d-label">Sound mode</span>
          <div class="chips">
            ${l.map((n) => y`<button
                class="chip ${t.attributes.sound_mode === n ? "active" : ""}"
                @click=${() => e.call(an(e.entityId, n), "set sound mode of")}
              >${n}</button>`)}
          </div>
        </div>` : x}
    ${f.length ? y`<div class="d-section">
    ...
    ${n.selectSource && p.length ? y`<div class="d-section">
          <span class="d-label">${d ? f.length ? "More apps" : "Apps" : "Source"}</span>
          <div class="chips">
            ${p.slice(0, 24).map((e) => {
		let n = t.attributes.source === e, r = d ? Jr(e) ?? "mdi:apps" : void 0;
		return y`<button
                class="chip ${r ? "with-icon" : ""} ${n ? "active" : ""}"
                @click=${() => m(e)}
              >
                ${r ? y`<hd-icon icon=${r} .size=${18}></hd-icon>` : x}
                <span>${e}</span>
              </button>`;
	})}
          </div>
...
C(), R();
function Rc(e, t) {
	let n = Number.isFinite(Number(t.state)), r = e.trend, i = r.length > 1 ? `Min ${I(Math.min(...r))}, max ${I(Math.max(...r))}, latest ${I(r[r.length - 1])}` : "";
	return y`
    <div class="d-value big">${bn(e.hass, t)}</div>
    ${n && r.length > 1 ? y`<div class="d-section">
...
function zc(e, t) {
	...
	return n.temperature != null && r.push(["Temperature", `${I(n.temperature)}°`]), n.humidity != null && r.push(["Humidity", `${Math.round(n.humidity)}%`]), n.wind_speed != null && r.push(["Wind", `${I(n.wind_speed)} ${n.wind_speed_unit ?? ""}`]), n.pressure != null && r.push(["Pressure", `${I(n.pressure)} ${n.pressure_unit ?? ""}`]), y`
    <div class="d-value big">${L(t.state)}</div>
    <div class="d-grid">
      ${r.map(([e, t]) => y`<div class="d-cell">
        <span class="k">${e}</span><span class="v">${t}</span>
      </div>`)}
    </div>
    ${e.forecast.length ? y`<div class="d-section">
...
function Vc(e) {
    ...
    <div class="d-section">
      ...
      <div class="d-grid">
        ${r.map((t) => y`<div class="d-cell">
          <span class="k">${L(t.key)}</span>
          <span class="v">${bn(e.hass, t.state)}</span>
        </div>`)}
      </div>
    </div>
    ${e.trend.length > 1 ? y`<div class="d-section">
...
function Hc(e) {
	let t = e.config?.type === "powerflow" ? e.config.options ?? {} : {}, n = To(e.hass, t), r = (t, n) => {
		...
		return r ? y`<div class="d-cell">
          <span class="k">${t}</span>
          <span class="v">${bn(e.hass, r)}</span>
        </div>` : x;
	};
	return y`
...
function Uc(e) {
	let t = e.config?.type === "solarcharging" ? e.config.options ?? {} : {}, n = zo(e.hass, t), r = n.tone === "eco" ? "var(--state-eco)" : n.tone === "accent" ? "var(--accent)" : "var(--text-secondary)", i = (e, t) => t == null ? x : y`<div class="d-cell"><span class="k">${e}</span><span class="v">${t}</span></div>`, a = (t, n, r, i) => {
      ...
      <hd-slider
        ...
        label=${n}
        @hd-change=${(r) => e.call(gn(t, r.detail.value), `set ${n.toLowerCase()}`)}
      ></hd-slider>
    </div>`;
	};
	return y`
    <div class="d-section d-row-between">
      ...
      <hd-toggle
        ...
        @hd-toggle=${() => t.master ? e.call(N(t.master), "toggle solar charging") : void 0}
      ></hd-toggle>
    </div>
...
C();
var Q = (e) => (t, n) => n ? e(t, n) : y`<div class="d-value big">Entity unavailable</div>
        <div class="d-meta">${t.entityId || "No entity configured"} was not found in Home Assistant.</div>`, Wc = {
	light: Q(Ic),
	climate: Q(Oc),
	generic: Q(Nc),
	cover: Q(Ac),
...
z([w({
	type: Boolean,
	reflect: !0
})], qc.prototype, "checked", void 0), z([w({
	type: Boolean,
	reflect: !0
})], qc.prototype, "disabled", void 0), z([w({ type: String })], qc.prototype, "label", void 0), qc = z([D("hd-toggle")], qc);
//#endregion
//#region src/primitives/color-wheel.ts
var Jc = /* @__PURE__ */ n({ HdColorWheel: () => Xc }), Yc, Xc, Zc = t((() => {
	C(), E(), O(), B(), Xc = (Yc = class extends S {
		constructor(...e) {
  ...
  `, Yc), z([w({ type: Number })], Xc.prototype, "hue", void 0), z([w({ type: Number })], Xc.prototype, "sat", void 0), z([w({
		type: Boolean,
		reflect: !0
	})], Xc.prototype, "disabled", void 0), Xc = z([D("hd-color-wheel")], Xc);
}));
C(), E(), O(), F(), $n(), yi(), nr(), ic(), dr(), br(), _r(), V(), Oi(), B();
var Qc, $c = (Qc = class extends S {
	constructor(...e) {
		super(...e), this.open = !1, this.entityId = "", this._trend = [], this._forecast = [], this._loadedKey = "", this._call = async (e, t = "update") => {
			if (this.hass) try {
				await Rt(this.hass, e);
			} catch {
				tr(this, {
	...
	async _maybeLoad() {
		...
		this._loadedKey = e, this._trend.length && (this._trend = []), this._forecast.length && (this._forecast = []), this.entityId.startsWith("light.") && (this.hass.states[this.entityId]?.attributes.supported_color_modes)?.some((e) => [
			...
			"rgbww",
			"rgbwww"
		].includes(e)) && Promise.resolve().then(() => (Zc(), Jc));
		let t = Ec(this.entityId, this.config);
		if (t && this.hass.connected) {
			let e = await vi(this.hass, t, 24);
			this._trend = e.map((e) => e.value);
		}
		this.entityId && Dc(this.entityId) && this.hass.connected && await this._loadForecast();
	}
	async _loadForecast() {
		if (!this.hass) return;
	...
	render() {
		if (!this.hass || !this.entityId && !this.config) return y`<hd-surface .open=${this.open} @hd-close=${() => this._close()}></hd-surface>`;
		let e = Rn(this.hass, this.entityId, this.config), t = {
			hass: this.hass,
			entityId: this.entityId,
			config: this.config,
			host: this,
			...
			call: this._call
		}, n = this.config?.type === "energy" ? "Live energy" : this.config?.type === "powerflow" ? "Live power flow" : e.displayState, r = this.config ? Ds(this.config.type) : void 0, i = this.hass.states[this.entityId], a = this.open && r?.detailRenderer ? Gc(r.detailRenderer, t, i) : x;
		return y`
      <hd-surface
        variant="auto"
        .open=${this.open}
  ...
  `, Qc);
z([w({ attribute: !1 })], $c.prototype, "hass", void 0), z([w({
	type: Boolean,
	reflect: !0
})], $c.prototype, "open", void 0), z([w({ type: String })], $c.prototype, "entityId", void 0), z([w({ attribute: !1 })], $c.prototype, "config", void 0), z([T()], $c.prototype, "_trend", void 0), z([T()], $c.prototype, "_forecast", void 0), $c = z([D("hd-detail")], $c), C(), E(), O(), V(), B();
var el, tl = (el = class extends S {
	constructor(...e) {
  ...
  `, el);
z([T()], tl.prototype, "_open", void 0), z([T()], tl.prototype, "_opts", void 0), tl = z([D("hd-confirm")], tl), C(), E(), O(), V(), B();
var nl, rl = (nl = class extends S {
	constructor(...e) {
	...
	render() {
		return y`<div aria-live="polite" aria-atomic="false">
      ${this._toasts.map((e) => y`<div class="toast ${e.tone ?? "neutral"}" role="status">
          ${e.icon ? y`<hd-icon .icon=${e.icon} .size=${18}></hd-icon>` : ""}
          <span>${e.message}</span>
        </div>`)}
    </div>`;
	}
  ...
  `, nl);
z([T()], rl.prototype, "_toasts", void 0), rl = z([D("hd-toasts")], rl), C(), E(), O(), uc(), Oi(), B();
var il, al = "hd-panel-appearance", $ = (il = class extends S {
	constructor(...e) {
	...
	_syncViewFromLocation() {
		let e = dc(this.route, this._base) || this._cfg.config.defaultView, t = this._views.some((t) => t.id === e);
		this._viewId = t ? e : this._cfg.config.defaultView;
	}
	_onNavigate(e) {
		e !== this._viewId && (this._viewId = e, hc(mc(this._base, e, this._cfg.config.defaultView)), this.updateComplete.then(() => this.renderRoot.querySelector("hd-app-shell")?.scrollToTop()));
	}
	_resolveDark() {
	...
	_cycleAppearance() {
		this._appearance = this._appearance === "auto" ? "light" : this._appearance === "light" ? "dark" : "auto", localStorage.setItem(al, this._appearance), this._applyTheme();
	}
	_applyKiosk() {
	...
	render() {
		if (!this.hass) return y`<div class="loading"><hd-skeleton w="220px" h="26px"></hd-skeleton></div>`;
      ...
      >
        ${e.length ? y`<div class="cfg-errors" role="alert">
              <strong>Dashboard configuration has ${e.length} error(s):</strong>
              <ul>
                ${e.slice(0, 8).map((e) => y`<li><code>${e.path}</code> — ${e.message}</li>`)}
              </ul>
            </div>` : x}
...
z([w({ attribute: !1 })], $.prototype, "hass", void 0), z([w({ type: Boolean })], $.prototype, "narrow", void 0), z([w({ attribute: !1 })], $.prototype, "panel", void 0), z([w({ attribute: !1 })], $.prototype, "route", void 0), z([T()], $.prototype, "_viewId", void 0), z([T()], $.prototype, "_appearance", void 0), z([T()], $.prototype, "_detailOpen", void 0), z([T()], $.prototype, "_detailEntityId", void 0), z([T()], $.prototype, "_detailConfig", void 0), z([lt("hd-confirm")], $.prototype, "_confirm", void 0), z([lt("hd-toasts")], $.prototype, "_toasts", void 0), $ = z([D("home-dashboard-panel")], $);
//#endregion
