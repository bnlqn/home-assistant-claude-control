...
var he, ge, _e, ve, ye, g, be, xe, Se, Ce, we, Te, Ee, De, Oe, ke, Ae, _, je, Me, Ne, Pe, v, Fe, y, b, Ie, x, Le, Re, ze, Be, Ve, He, Ue, We, Ge, Ke, qe, Je, Ye = t((() => {
	he = globalThis, ge = (e) => e, _e = he.trustedTypes, ve = _e ? _e.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, ye = "$lit$", g = `lit$${Math.random().toFixed(9).slice(2)}$`, be = "?" + g, xe = `<${be}>`, Se = document, Ce = () => Se.createComment(""), we = (e) => e === null || typeof e != "object" && typeof e != "function", Te = Array.isArray, Ee = (e) => Te(e) || typeof e?.[Symbol.iterator] == "function", De = "[ 	\n\f\r]", Oe = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ke = /-->/g, Ae = />/g, _ = RegExp(`>|${De}(?:([^\\s"'>=/]+)(${De}*=${De}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`, "g"), je = /'/g, Me = /"/g, Ne = /^(?:script|style|textarea|title)$/i, Pe = (e) => (t, ...n) => ({
		_$litType$: e,
		strings: t,
		values: n
	}), v = Pe(1), Fe = Pe(2), Pe(3), y = Symbol.for("lit-noChange"), b = Symbol.for("lit-nothing"), Ie = /* @__PURE__ */ new WeakMap(), x = Se.createTreeWalker(Se, 129), Le = (e, t) => {
		let n = e.length - 1, r = [], i, a = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", o = Oe;
		for (let t = 0; t < n; t++) {
			let n = e[t], s, c, l = -1, u = 0;
			for (; u < n.length && (o.lastIndex = u, c = o.exec(n), c !== null);) u = o.lastIndex, o === Oe ? c[1] === "!--" ? o = ke : c[1] === void 0 ? c[2] === void 0 ? c[3] !== void 0 && (o = _) : (Ne.test(c[2]) && (i = RegExp("</" + c[2], "g")), o = _) : o = Ae : o === _ ? c[0] === ">" ? (o = i ?? Oe, l = -1) : c[1] === void 0 ? l = -2 : (l = o.lastIndex - c[2].length, s = c[1], o = c[3] === void 0 ? _ : c[3] === "\"" ? Me : je) : o === Me || o === je ? o = _ : o === ke || o === Ae ? o = Oe : (o = _, i = void 0);
			let d = o === _ && e[t + 1].startsWith("/>") ? " " : "";
			a += o === Oe ? n + xe : l >= 0 ? (r.push(s), n.slice(0, l) + ye + n.slice(l) + g + d) : n + g + (l === -2 ? t : d);
		}
				...
				if (i.nodeType === 1) {
					...
					if (Ne.test(i.tagName)) {
						...
						if (t > 0) {
							...
							for (let n = 0; n < t; n++) i.append(e[n], Ce()), x.nextNode(), c.push({
								type: 2,
								index: ++a
							});
							i.append(e[t], Ce());
		...
		_$AI(e, t = this) {
			e = me(this, e, t), we(e) ? e === b || e == null || e === "" ? (this._$AH !== b && this._$AR(), this._$AH = b) : e !== this._$AH && e !== y && this._(e) : e._$litType$ === void 0 ? e.nodeType === void 0 ? Ee(e) ? this.k(e) : this._(e) : this.T(e) : this.$(e);
		}
		O(e) {
		...
		_(e) {
			this._$AH !== b && we(this._$AH) ? this._$AA.nextSibling.data = e : this.T(Se.createTextNode(e)), this._$AH = e;
		}
		$(e) {
			let { values: t, _$litType$: n } = e, r = typeof n == "number" ? this._$AC(e) : (n.el === void 0 && (n.el = Re.createElement(pe(n.h, n.h[0]), this.options)), n);
		...
		_$AC(e) {
			...
			return t === void 0 && Ie.set(e.strings, t = new Re(e)), t;
		}
		k(t) {
		...
		_$AI(e, t = this, n, r) {
			...
			if (i === void 0) e = me(this, e, t, 0), a = !we(e) || e !== this._$AH && e !== y, a && (this._$AH = e);
			else {
				let r = e, o, s;
				for (e = i[0], o = 0; o < i.length - 1; o++) s = me(this, r[n + o], t, o), s === y && (s = this._$AH[o]), a ||= !we(s) || s !== this._$AH[o], s === b ? e = b : e !== b && (e += (s ?? "") + i[o + 1]), this._$AH[o] = s;
			}
			a && !r && this.j(e);
		}
		j(e) {
		...
		B: He,
		F: Ge
	}, qe = he.litHtmlPolyfillSupport, qe?.(Re, Be), (he.litHtmlVersions ??= []).push("3.3.3"), Je = (e, t, n) => {
		let r = n?.renderBefore ?? t, i = r._$litPart$;
		if (i === void 0) {
			let e = n?.renderBefore ?? null;
			r._$litPart$ = i = new Be(t.insertBefore(Ce(), e), e, void 0, n ?? {});
		}
		return i._$AI(e), i;
	};
})), Xe, S, Ze, Qe = t((() => {
	fe(), fe(), Ye(), Ye(), Xe = globalThis, S = class extends de {
		constructor() {
	...
	}, S._$litElement$ = !0, S.finalized = !0, Xe.litElementHydrateSupport?.({ LitElement: S }), Ze = Xe.litElementPolyfillSupport, Ze?.({ LitElement: S }), (Xe.litElementVersions ??= []).push("4.2.2");
})), $e = t((() => {})), C = t((() => {
	fe(), Ye(), Qe(), $e();
})), et = t((() => {}));
//#endregion
...
function w(e) {
	return (t, n) => typeof n == "object" ? nt(e, t, n) : ((e, t, n) => {
...
var it = t((() => {
	...
	ot = (e, t, n) => (n.configurable = !0, n.enumerable = !0, Reflect.decorate && typeof t != "object" && Object.defineProperty(e, t, n), n);
}));
//#endregion
...
var lt = t((() => {
	st();
})), ut = t((() => {})), dt = t((() => {})), ft = t((() => {})), pt = t((() => {})), E = t((() => {
	et(), rt(), it(), at(), lt(), ut(), dt(), ft(), pt();
}));
//#endregion
...
function Ot(e) {
	return {
		...
		close: k(e, A.CLOSE),
		stop: k(e, A.STOP),
		setPosition: k(e, A.SET_POSITION),
		tilt: k(e, A.OPEN_TILT) || k(e, A.CLOSE_TILT),
		setTilt: k(e, A.SET_TILT_POSITION)
	};
}
function kt(e) {
	return {
...
function At(e) {
	return {
		...
		pause: k(e, j.PAUSE),
		stop: k(e, j.STOP),
		next: k(e, j.NEXT_TRACK),
		previous: k(e, j.PREVIOUS_TRACK),
		volumeSet: k(e, j.VOLUME_SET),
		volumeStep: k(e, j.VOLUME_STEP),
		mute: k(e, j.VOLUME_MUTE),
		selectSource: k(e, j.SELECT_SOURCE),
		selectSoundMode: k(e, j.SELECT_SOUND_MODE),
		power: k(e, j.TURN_ON) || k(e, j.TURN_OFF)
	};
}
function jt(e) {
	return {
		...
		pause: k(e, M.PAUSE),
		stop: k(e, M.STOP),
		returnHome: k(e, M.RETURN_HOME),
		fanSpeed: k(e, M.FAN_SPEED),
		battery: k(e, M.BATTERY),
		locate: k(e, M.LOCATE)
	};
}
function Mt(e) {
...
function Rn(e, t, n) {
	...
	let i = wt(t), a = Fr(t), o = e?.states[t];
	...
	let s = n?.name ?? yn(o, R(t.split(".")[1] ?? t)), c = Tt(o), l = Et(o), u = {
		entityId: t,
		domain: i,
		stateObj: o,
		exists: !0,
...
var Zn, Qn, $n = t((() => {
	zr(), N(), z(), I(), jn(), Ln(), Zn = /* @__PURE__ */ new Set([
		"on",
		"open",
		"playing",
		"home",
...
var V = t((() => {})), ar, or, H = t((() => {
  ...
  `, ar), B([w({ type: String })], or.prototype, "icon", void 0), B([w({ type: Number })], or.prototype, "size", void 0), or = B([D("hd-icon")], or);
})), sr, U, W = t((() => {
	C(), E(), O(), $n(), H(), V(), U = (sr = class extends S {
		constructor(...e) {
  ...
  `, sr), B([w({ type: String })], U.prototype, "icon", void 0), B([w({ type: String })], U.prototype, "name", void 0), B([w({ type: String })], U.prototype, "stateText", void 0), B([w({ type: String })], U.prototype, "secondary", void 0), B([w({ type: String })], U.prototype, "size", void 0), B([w({ type: String })], U.prototype, "accent", void 0), B([w({ type: String })], U.prototype, "glyphColor", void 0), B([w({
		type: Boolean,
		reflect: !0
	})], U.prototype, "active", void 0), B([w({
		type: Boolean,
		reflect: !0
	})], U.prototype, "unavailable", void 0), B([w({ type: Boolean })], U.prototype, "hasDetail", void 0), B([w({ type: String })], U.prototype, "quickKind", void 0), B([w({ type: String })], U.prototype, "quickLabel", void 0), B([w({ type: String })], U.prototype, "actionState", void 0), B([w({ type: Boolean })], U.prototype, "bleed", void 0), B([w({ type: String })], U.prototype, "layout", void 0), U = B([D("hd-widget-frame")], U);
})), G, K = t((() => {
	C(), E(), I(), $n(), nr(), W(), V(), G = class extends S {
		constructor(...e) {
	...
	}, B([w({ attribute: !1 })], G.prototype, "hass", void 0), B([w({ attribute: !1 })], G.prototype, "config", void 0), B([w({ type: String })], G.prototype, "currentSize", void 0), B([w({ type: String })], G.prototype, "layout", void 0), B([T()], G.prototype, "actionState", void 0);
})), cr, q, lr = t((() => {
	C(), E(), O(), H(), V(), q = (cr = class extends S {
		constructor(...e) {
  ...
  `, cr), B([w({ type: Number })], q.prototype, "value", void 0), B([w({ type: Number })], q.prototype, "min", void 0), B([w({ type: Number })], q.prototype, "max", void 0), B([w({ type: Number })], q.prototype, "step", void 0), B([w({
		type: Boolean,
		reflect: !0
	})], q.prototype, "vertical", void 0), B([w({
		type: Boolean,
		reflect: !0
	})], q.prototype, "disabled", void 0), B([w({ type: String })], q.prototype, "label", void 0), B([w({ type: String })], q.prototype, "icon", void 0), B([w({ type: String })], q.prototype, "valueText", void 0), B([w({ type: String })], q.prototype, "color", void 0), B([T()], q.prototype, "_dragging", void 0), B([T()], q.prototype, "_dragValue", void 0), q = B([D("hd-slider")], q);
})), ur = /* @__PURE__ */ n({ LightWidget: () => fr }), dr, fr, pr = t((() => {
	C(), E(), O(), K(), N(), I(), W(), lr(), V(), fr = (dr = class extends G {
		constructor(...e) {
  ...
  `, dr), B([T()], fr.prototype, "_optimistic", void 0), fr = B([D("hd-widget-light")], fr);
})), mr, J, hr = t((() => {
	C(), E(), O(), H(), V(), J = (mr = class extends S {
		constructor(...e) {
  ...
  `, mr), B([w({ type: String })], J.prototype, "icon", void 0), B([w({ type: String })], J.prototype, "label", void 0), B([w({
		type: Boolean,
		reflect: !0
	})], J.prototype, "disabled", void 0), B([w({
		type: Boolean,
		reflect: !0
	})], J.prototype, "loading", void 0), B([w({ type: String })], J.prototype, "variant", void 0), B([w({ type: Number })], J.prototype, "size", void 0), J = B([D("hd-icon-button")], J);
})), gr, _r, vr = t((() => {
	C(), E(), O(), H(), V(), _r = (gr = class extends S {
		constructor(...e) {
  ...
  `, gr), B([w({ attribute: !1 })], _r.prototype, "options", void 0), B([w({ type: String })], _r.prototype, "value", void 0), B([w({
		type: Boolean,
		reflect: !0
	})], _r.prototype, "disabled", void 0), B([w({ type: String })], _r.prototype, "label", void 0), _r = B([D("hd-segmented")], _r);
})), yr = /* @__PURE__ */ n({ ClimateWidget: () => Sr }), br, xr, Sr, Cr = t((() => {
	C(), E(), O(), K(), N(), I(), z(), W(), hr(), vr(), V(), xr = {
		off: "mdi:power",
		heat: "mdi:fire",
		cool: "mdi:snowflake",
      ...
      ${r == null ? b : v`<div class="now">Now ${L(r)}°</div>`}
    </div>`;
		}
		_renderModes() {
  ...
  `, br), B([T()], Sr.prototype, "_optimisticTarget", void 0), Sr = B([D("hd-widget-climate")], Sr);
}));
//#endregion
...
function Er(e) {
	...
	return t.forEach((e, t) => {
		...
		(typeof r.entity != "string" || !Or.test(r.entity)) && n.push({
...
var Or, kr, Ar, jr, Mr, Nr = t((() => {
	Or = /^[a-z_]+\.[a-z0-9_]+$/, kr = {
		...
		quickAction: "none",
		hasDetail: !0,
		dependencyIds: (e) => [...e.entity ? [e.entity] : [], ...Tr(e.options).map((e) => e.entity)],
		validateOptions: Er,
...
function Ir(e) {
	...
	for (let t = 0; t < (e.views ?? []).length; t++) {
		...
		for (let e = 0; e < (s.widgets ?? []).length; e++) {
			let t = s.widgets[e], r = Lr(t, `${c}.widgets[${e}]`, a, n);
			r && l.push(r);
		}
		o.push({
			...s,
...
function Lr(e, t, n, r) {
	...
	if (n.add(e.id), !yt.includes(e.type)) return r(`${t}.type`, `Unknown widget type "${e.type}".`), null;
	let i = e.type, a = Dr(i), o = !0;
	if ((a?.requiresEntity ?? !St.includes(i)) && !e.entity ? (r(`${t}.entity`, `Widget "${e.id}" (${i}) requires an \`entity\`.`), o = !1) : e.entity && !Pr(e.entity) && (r(`${t}.entity`, `"${e.entity}" is not a valid entity_id (expected e.g. light.living_room).`), o = !1), !e.size || typeof e.size != "object") r(`${t}.size`, `Widget "${e.id}" is missing a size set.`), o = !1;
	else {
		let n = a?.supportedSizes ?? xt[i];
		for (let a of vt) {
			let s = e.size[a];
			if (!s) {
			...
			if (!_t.includes(s)) {
				r(`${t}.size.${a}`, `Invalid size "${s}" (allowed: ${_t.join(", ")}).`), o = !1;
				continue;
			}
	...
	if (e.type === "group") {
		...
		if (!Array.isArray(i) || i.length === 0) r(`${t}.options.children`, `Group "${e.id}" must have a non-empty \`children\` array.`), o = !1;
			...
			let a = i.map((e, i) => Lr(e, `${t}.options.children[${i}]`, n, r)).filter((e) => e !== null);
...
var Rr, zr = t((() => {
	Ct(), Nr(), Rr = /^[a-z_]+\.[a-z0-9_]+$/;
}));
//#endregion
//#region src/panel/router.ts
function Br(e, t, n = window.location) {
	return e && typeof e.path == "string" ? Hr(e.path) : Vr(n.pathname, t);
}
function Vr(e, t) {
...
B([w({
	type: Boolean,
	reflect: !0
})], Y.prototype, "open", void 0), B([w({ type: String })], Y.prototype, "variant", void 0), B([w({ type: String })], Y.prototype, "heading", void 0), B([w({ type: String })], Y.prototype, "subheading", void 0), B([w({ type: Boolean })], Y.prototype, "headless", void 0), B([T()], Y.prototype, "_resolved", void 0), B([T()], Y.prototype, "_dragY", void 0), B([T()], Y.prototype, "_closing", void 0), B([ct(".container")], Y.prototype, "_container", void 0), Y = B([D("hd-surface")], Y), C(), E(), O(), H(), hr(), V();
var qr, X = (qr = class extends S {
	constructor(...e) {
		super(...e), this.views = [], this.currentViewId = "", this.productTitle = "Home", this.subtitle = "", this.connected = !0, this.appearance = "auto", this._switcherOpen = !1, this._elementWidth = new Gr(this);
	}
	get _mode() {
  ...
  `, qr);
B([w({ attribute: !1 })], X.prototype, "views", void 0), B([w({ type: String })], X.prototype, "currentViewId", void 0), B([w({ type: String })], X.prototype, "productTitle", void 0), B([w({ type: String })], X.prototype, "subtitle", void 0), B([w({ type: Boolean })], X.prototype, "connected", void 0), B([w({ type: String })], X.prototype, "appearance", void 0), B([T()], X.prototype, "_switcherOpen", void 0), X = B([D("hd-app-shell")], X);
//#endregion
...
Ye();
var { I: Zr } = Ke, Qr = (e) => e, $r = () => document.createComment(""), ei = (e, t, n) => {
...
var oi = (e, t, n) => {
	...
	update(e, [t, n, r]) {
		...
		else if (l === void 0 && (l = oi(o, p, m), u = oi(s, d, f)), l.has(s[d])) {
			if (l.has(s[f])) {
...
Ye();
var xi = Symbol.for(""), Si = (e) => {
	if (e?.r === xi) return e?._$litStatic$;
}, Ci = (e) => ({
	_$litStatic$: e,
	r: xi
}), wi = /* @__PURE__ */ new Map(), Ti = ((e) => (t, ...n) => {
	let r = n.length, i, a, o = [], s = [], c, l = 0, u = !1;
	for (; l < r;) {
		for (c = t[l]; l < r && (a = n[l], (i = Si(a)) !== void 0);) c += i + t[++l], u = !0;
		l !== r && s.push(a), o.push(c), l++;
	}
	if (l === r && o.push(t[r]), u) {
		let e = o.join("$$lit$$");
		(t = wi.get(e)) === void 0 && (o.raw = o, wi.set(e, t = o)), n = s;
	}
	return e(t, ...n);
})(v);
C(), E(), O(), V();
var Ei, Di = (Ei = class extends S {
	constructor(...e) {
		super(...e), this.currentSize = "4x2", this.layout = "row", this._elementWidth = new Gr(this);
	}
	get _opts() {
	...
	render() {
		...
		let t = this._elementWidth.width, n = this._variant, r = _i(n, t), i = ci(t).bucket, a = gi(n), o = this._opts.label, s = a !== "row", c = `--cols:${r}; --gap:12px; --unit:${n === "sensors" ? 84 : n === "media" ? 116 : n === "tiles" ? 100 : fi(t || 1024, {
			columns: r,
			gap: 12,
			pad: 0,
			bucket: i
      ...
      <section class="section">
        ${o ? v`<h2 class="head">${o}</h2>` : b}
        <div class="grid" style=${c}>
          ${si(e, (e) => e.id, (e) => {
			let t = s ? ui(e, i) : null;
			return bo(e, t ?? (s ? "1x1" : li(e, i)), r, this.hass, t ? "row" : a);
		})}
        </div>
      </section>
    `;
  ...
  `, Ei);
B([w({ attribute: !1 })], Di.prototype, "hass", void 0), B([w({ attribute: !1 })], Di.prototype, "config", void 0), B([w({ type: String })], Di.prototype, "currentSize", void 0), B([w({ type: String })], Di.prototype, "layout", void 0), Di = B([D("hd-group")], Di), C(), O(), K(), nr(), W(), V();
function Oi(e, t) {
	let n = e.vm;
	return v`<hd-widget-frame
    .icon=${n.icon}
...
Pi = B([D("hd-widget-scene")], Pi);
var Fi = class extends Ni {};
Fi = B([D("hd-widget-script")], Fi);
var Ii = class extends Ni {};
Ii = B([D("hd-widget-button")], Ii);
...
C(), E(), O(), H(), V();
var zi, Bi, Vi, Hi, Ui = (zi = class extends S {
	constructor(...e) {
  ...
  `, zi);
B([w({ type: Number })], Ui.prototype, "value", void 0), B([w({ type: String })], Ui.prototype, "color", void 0), B([w({ type: String })], Ui.prototype, "label", void 0), Ui = B([D("hd-progress")], Ui);
var Wi = (Bi = class extends S {
	constructor(...e) {
  ...
  `, Bi);
B([w({ type: String })], Wi.prototype, "icon", void 0), B([w({ type: String })], Wi.prototype, "text", void 0), B([w({ type: String })], Wi.prototype, "tone", void 0), Wi = B([D("hd-status-badge")], Wi);
var Gi = (Vi = class extends S {
	constructor(...e) {
  ...
  `, Vi);
B([w({ type: String })], Gi.prototype, "w", void 0), B([w({ type: String })], Gi.prototype, "h", void 0), B([w({ type: String })], Gi.prototype, "radius", void 0), Gi = B([D("hd-skeleton")], Gi);
var Ki = (Hi = class extends S {
	constructor(...e) {
  ...
  `, Hi);
B([w({ attribute: !1 })], Ki.prototype, "points", void 0), B([w({ type: String })], Ki.prototype, "color", void 0), B([w({ type: Boolean })], Ki.prototype, "area", void 0), B([w({ type: String })], Ki.prototype, "summary", void 0), Ki = B([D("hd-trend")], Ki), C(), E(), O(), K(), $n(), W(), V();
var qi, Ji = (qi = class extends G {
	constructor(...e) {
	...
	renderContent() {
		let e = this.vm, t = e.stateObj, n = t ? Number(t.state) : NaN, r = Number.isFinite(n) && t.state.trim() !== "", i = t?.attributes.unit_of_measurement, a = Xn(e.accent), o = e.available && r ? v`<div class="value">
            <span>${Yi(n)}</span>${i ? v`<span class="unit">${i}</span>` : b}
      ...
      >
        ${o}
        ${this._isBig && r && this._trend.length > 1 ? v`<div class="trend">
              <hd-trend
                .points=${this._trend}
                .color=${a.fg}
  ...
  `, qi);
B([T()], Ji.prototype, "_trend", void 0), Ji = B([D("hd-widget-sensor")], Ji);
function Yi(e) {
...
C(), E(), O(), K(), N(), I(), W(), hr(), lr(), V();
var Xi, Zi = (Xi = class extends G {
	constructor(...e) {
		super(...e), this._optimistic = null, this._optimisticTs = 0, this._debounce = 0;
	}
	get _position() {
  ...
  `, Xi);
B([T()], Zi.prototype, "_optimistic", void 0), Zi = B([D("hd-widget-cover")], Zi);
//#endregion
...
function $i(e) {
	return Qi[e.replace(/\u00a0/g, " ").trim().toLowerCase()];
}
function ea(e) {
	return e.some((e) => $i(e) !== void 0);
}
function ta(e) {
...
var aa = /* @__PURE__ */ new Map(), oa = /* @__PURE__ */ new Map();
function sa(e) {
	return aa.get(e);
}
function ca(e) {
	if (aa.has(e)) return Promise.resolve(aa.get(e) ?? null);
	let t = oa.get(e);
	if (t) return t;
	let n = la(e).then((t) => (aa.set(e, t), oa.delete(e), t)).catch(() => (aa.set(e, null), oa.delete(e), null));
	return oa.set(e, n), n;
}
function la(e) {
	return new Promise((t) => {
		let n = new Image();
		n.crossOrigin = "anonymous", n.decoding = "async", n.onload = () => t(ua(n)), n.onerror = () => t(null), n.src = e;
	});
}
function ua(e) {
...
var pa, ma = {
	...
	get _isPlaying() {
		...
		if (this._optimistic != null) {
			if (Date.now() - this._optimisticTs > ha) return this._optimistic = null, e;
	...
	_syncTicker() {
		let e = this._isPlaying && !!ia(this.vm.stateObj);
	...
	_ambientVars() {
		let e = this._artColor ?? ma;
		return [
			`--np-dark:${fa(da(e, .62))}`,
			`--np-scrim-strong:${fa(da(e, .55), .9)}`,
			`--np-scrim-soft:${fa(da(e, .35), .45)}`
		].join(";");
	}
	_transport(e) {
	...
	renderContent() {
		let e = this.vm, t = At(e.stateObj), n = this.currentSize, r = e.stateObj?.attributes.entity_picture, i = e.stateObj?.attributes.app_name, a = e.stateObj?.attributes.media_title, o = this._rawState, s = i ? $i(i) : void 0;
      ...
      `;
		let c = n === "2x2", l = ia(e.stateObj), u = r ? `background-image:url("${r}")` : "";
		return v`
      <hd-widget-frame
        bleed
        .name=${e.name}
  ...
  `, pa);
B([T()], ga.prototype, "_artColor", void 0), B([T()], ga.prototype, "_marquee", void 0), ga = B([D("hd-widget-media")], ga);
//#endregion
...
C(), O(), K(), N(), I(), z(), jn(), W(), hr(), H(), vr(), V();
var va, ya = (va = class extends G {
	get _branded() {
	...
	_progress() {
		...
		return typeof e.area == "number" && e.area > 0 && n.push(`${L(e.area)} m²`), typeof e.cleaningTime == "number" && e.cleaningTime > 0 && n.push(`${Math.round(e.cleaningTime)} min`), v`<div class="progress">
	...
	_heroControls(e) {
		...
		return v`<div class="controls" @click=${(e) => e.stopPropagation()}>
      ${i && e.pause ? v`<button class="pill primary" aria-label="Pause" ?disabled=${r} @click=${() => a(() => sn(this.entityId), "pause")}>
            <hd-icon icon="mdi:pause" .size=${20}></hd-icon>
          </button>` : v`<button class="pill primary" aria-label="Start" ?disabled=${r || !e.start} @click=${() => a(() => on(this.entityId), "start")}>
            <hd-icon icon="mdi:play" .size=${20}></hd-icon>
          </button>`}
      ${e.returnHome ? v`<button class="pill" aria-label="Return to dock" ?disabled=${r || n === "docked"} @click=${() => a(() => cn(this.entityId), "dock")}>
            <hd-icon icon="mdi:home-import-outline" .size=${20}></hd-icon>
          </button>` : b}
      ${e.locate ? v`<button class="pill" aria-label="Locate" ?disabled=${r} @click=${() => a(() => un(this.entityId), "locate")}>
	...
	_renderHero(e) {
      ...
      >
        <div class="hero" ?data-cleaning=${r}>
          ...
          <img
            class="robot"
            src=${_a("assets/roborock-s8.webp")}
            alt=""
            aria-hidden="true"
            draggable="false"
          />
  ...
  `, va);
ya = B([D("hd-widget-vacuum")], ya), C(), E(), O(), K(), Ln(), z(), W(), H(), V();
var ba, xa = (ba = class extends G {
	constructor(...e) {
	...
	_metrics() {
		...
		return e.humidity != null && t.push(["mdi:water-percent", `${Math.round(e.humidity)}%`]), e.wind_speed != null && t.push(["mdi:weather-windy", `${L(e.wind_speed)} ${e.wind_speed_unit ?? "km/h"}`]), v`<div class="metrics">
      ${t.map(([e, t]) => v`<span class="metric"><hd-icon .icon=${e} .size=${14}></hd-icon>${t}</span>`)}
    </div>`;
	}
	_forecastStrip() {
		return this._forecast.length ? v`<div class="forecast">
  ...
  `, ba);
B([T()], xa.prototype, "_forecast", void 0), xa = B([D("hd-widget-weather")], xa), C(), E(), O(), K(), z(), W(), V();
var Sa, Ca = (Sa = class extends G {
	constructor(...e) {
		super(...e), this._trend = [], this._fetchedFor = "";
	}
	hasDetail() {
	...
	renderContent() {
      ...
      >
        ...
        <div class="stats">
          ...
          ${r == null ? b : v`<hd-status-badge tone="eco" icon="mdi:weather-sunny" text=${`${L(r)} kWh today`}></hd-status-badge>`}
          ${a != null && n == null ? v`<hd-status-badge tone="neutral" icon="mdi:chart-bell-curve" text=${`${L(a)} kWh left`}></hd-status-badge>` : b}
          ${i != null && (o === "2x2" || o === "2x1") ? v`<hd-status-badge tone="neutral" icon="mdi:chart-line" text=${`${L(i)} kWh forecast`}></hd-status-badge>` : b}
        </div>

        ${o === "2x2" && this._trend.length > 1 ? v`<div class="trend">
  ...
  `, Sa);
B([T()], Ca.prototype, "_trend", void 0), Ca = B([D("hd-widget-energy")], Ca);
function wa(e) {
	if (!e) return null;
...
function Ea(e) {
	let t = e.grid ?? 0, n = Ta(e.solar ?? 0), r = Ta(e.car ?? 0), i = e.carActive ? r : 0, a = Ta(t), o = Ta(-t), s = Ta(n + t - i), c = a > 25 || o > 25, l = n > 25, u = e.carActive && i > 25, d = a > 25 ? "import" : o > 25 ? "export" : "idle", f = {
		watts: d === "export" ? o : a,
...
var ka;
function Aa(e, t) {
	let n = (t) => t ? wa(e.states[t]) : null, r = n(t.gridPower), i = n(t.solarPower), a = n(t.carPower);
	if ((a == null || a === 0) && t.carPowerAlt) {
		let e = n(t.carPowerAlt);
		e != null && e > 0 && (a = e);
	}
	let o = t.carActive ? e.states[t.carActive]?.state : void 0, s = t.carActiveAlt ? e.states[t.carActiveAlt]?.state : void 0, c = Da(o) || Da(s), l = Oa(o) || Oa(s);
	return Ea({
		grid: r,
		solar: i,
		car: a,
...
function Ia(e, t, n, r, i) {
	let [a, o] = Fa(t[0] - e[0], t[1] - e[1]), s = [e[0] + a * r, e[1] + o * r], [c, l] = Fa(t[0] - n[0], t[1] - n[1]), u = [n[0] + c * i, n[1] + l * i], d = `M ${s[0].toFixed(2)} ${s[1].toFixed(2)} Q ${t[0]} ${t[1]} ${u[0].toFixed(2)} ${u[1].toFixed(2)}`, [f, p] = Fa(u[0] - t[0], u[1] - t[1]), m = 3.1, h = [u[0] - f * m, u[1] - p * m], ee = -p * m * .6, te = f * m * .6;
	return {
		d,
		chevron: `${u[0].toFixed(2)},${u[1].toFixed(2)} ${(h[0] + ee).toFixed(2)},${(h[1] + te).toFixed(2)} ${(h[0] - ee).toFixed(2)},${(h[1] - te).toFixed(2)}`
	};
}
var La = (e, t, n) => e + (t - e) * n, Ra = (e) => 1 - (1 - e) ** 3, za = (ka = class extends S {
	constructor(...e) {
		super(...e), this._shown = {
			grid: 0,
			solar: 0,
	...
	_retween() {
		...
		let i = (e) => {
			let a = Math.min(1, (e - r) / 420), o = Ra(a);
			this._shown = {
				grid: La(n.grid, t.grid, o),
				solar: La(n.solar, t.solar, o),
				house: La(n.house, t.house, o),
				car: La(n.car, t.car, o)
	...
	_node(e, t, n, r, i, a) {
      ...
      <div class="label">${ja(this._shown[e])}</div>
	...
	render() {
		let e = this.model;
		if (!e) return b;
		let t = "var(--state-eco)", n = "var(--accent)", r = e.grid.mode !== "export", i = e.grid.mode === "export" ? t : n, a = e.paths.houseCar.source === "solar" ? t : n, o = r ? Ia(Z.grid, Ma.grid, Z.house, Na, Pa) : Ia(Z.house, Ma.grid, Z.grid, Pa, Na), s = Ia(Z.grid, Ma.grid, Z.house, Na, Pa), c = Ia(Z.solar, Ma.solar, Z.house, Na, Pa), l = Ia(Z.house, Ma.car, Z.car, Pa, Na), u = e.grid.mode === "export" ? t : e.grid.mode === "import" ? n : "var(--text-tertiary)", d = e.grid.mode === "export" ? `Exporting ${ja(e.grid.watts)}` : e.grid.mode === "import" ? `Importing ${ja(e.grid.watts)}` : "Grid balanced", f = e.solar.watts > 25;
		return v`
      <div class="stage">
  ...
  `, ka);
B([w({ attribute: !1 })], za.prototype, "model", void 0), B([T()], za.prototype, "_shown", void 0), za = B([D("hd-flow-diagram")], za);
var Ba = class extends G {
	...
	renderContent() {
		let e = this.hass ? Aa(this.hass, this._opts) : void 0, t = e?.grid.mode === "export" ? "eco" : "accent";
		return v`
      <hd-widget-frame
        bleed
...
Ba = B([D("hd-widget-powerflow")], Ba), C(), O(), K(), I(), z(), W(), H(), V();
var Va, Ha = "#E82127", Ua = (e, t) => {
	if (!t || !e) return null;
	let n = e.states[t];
	if (!n) return null;
	let r = Number(n.state);
	return Number.isFinite(r) ? r : null;
}, Wa = (e, t) => t ? e?.states[t]?.state : void 0;
function Ga(e, t) {
	let n = Wa(e, t.master) === "on", r = Wa(e, t.vehicleConnected) === "on", i = Wa(e, t.chargingState), a = Ua(e, t.chargePower), o = Ua(e, t.battery), s = Ua(e, t.chargeLimit), c = Ua(e, t.sessionEnergy), l = Ua(e, t.chargeRate), u = Ua(e, t.chargeCurrent), d = i === "charging" || i === "starting" || (a ?? 0) > .1, f = i === "complete", p;
...
var Ka = (Va = class extends G {
	...
	_toggleMaster() {
		...
		e && this.callService(P(e), { errorVerb: "toggle solar charging" });
	}
	_renderHero(e) {
      ...
      >
        <div class="hero" ?data-charging=${r && e.armed}>
          ...
          <img
            class="car"
            src=${_a("assets/tesla-model-3.webp")}
            alt=""
            aria-hidden="true"
            draggable="false"
          />
	...
	renderContent() {
		let e = Ga(this.hass, this._opts), t = this.currentSize;
  ...
  `, Va);
Ka = B([D("hd-widget-solarcharging")], Ka);
//#endregion
...
function Ja(e, t, n = /* @__PURE__ */ new Date()) {
	let r = new Date(n);
...
async function Xa(e, t, n, r) {
	...
	return i.length ? qa(await e.callWS({
...
var Za, Qa = (e) => {
...
}, $a = (e) => Math.abs(e) >= 100 ? Math.round(e).toString() : e.toFixed(1), eo = (Za = class extends S {
	constructor(...e) {
	...
	render() {
		...
		let r = Qa(n), i = t.map((e) => `${e.label} ${$a(this._total(e))} ${this.unit}`).join(", ");
		return v`
      <div class="wrap" role="img" aria-label=${i}>
        <div class="plot">
          <span class="ymax">${$a(r)} ${this.unit}</span>
        ...
        ${this.legend ? v`<div class="legend">
              ${this.series.map((e) => v`<span class="key" style=${`--c:${e.color}`}>
                  <i></i>${e.label} <b>${$a(this._total(e))} ${this.unit}</b>
                </span>`)}
            </div>` : b}
      </div>
    `;
  ...
  `, Za);
B([w({ attribute: !1 })], eo.prototype, "series", void 0), B([w({ attribute: !1 })], eo.prototype, "labels", void 0), B([w({ type: String })], eo.prototype, "unit", void 0), B([w({ type: Boolean })], eo.prototype, "legend", void 0), eo = B([D("hd-bar-chart")], eo), C(), E(), O(), K(), W(), vr(), V();
var to, no = [
	{
		key: "solar",
		label: "Solar",
	...
	_ids() {
		return no.map((e) => this._opts[e.key]).filter((e) => typeof e == "string");
	}
	updated() {
	...
	async _maybeFetch() {
		...
		if (t !== this._fetchKey) {
			this._fetchKey = t;
			try {
				let t = Ja(this._period, ro[this._period]);
				this._data = await Xa(this.hass, e, this._period, t);
			} catch {
				this._data = {};
			}
		}
	...
	_chart() {
		let e = ro[this._period], t = /* @__PURE__ */ new Set();
		for (let e of no) {
		...
		return {
			...
			series: no.filter((e) => this._opts[e.key]).map((e) => {
  ...
  `, to);
B([T()], io.prototype, "_period", void 0), B([T()], io.prototype, "_data", void 0), B([T()], io.prototype, "_periodInit", void 0), io = B([D("hd-widget-energychart")], io), C(), O(), K(), $n(), z(), H(), V();
var ao, oo = (ao = class extends G {
	get _opts() {
		return this.config.options ?? {};
	}
	relevantEntityIds() {
	...
	_statusText() {
		...
		if (e.status === "gridDirection") {
			let e = this.entityId ? this.hass?.states[this.entityId] : void 0, t = e ? wa(e) : null;
		...
		if (e.status === "carCharge") {
			...
			return (e.connected ? this.hass?.states[e.connected]?.state : void 0) === "on" || Oa(t) ? Da(t) ? "Charging" : "Plugged in" : "Disconnected";
		}
		return "";
	}
	renderContent() {
  ...
  `, ao);
oo = B([D("hd-widget-metrictile")], oo), C(), E(), O(), K(), z(), V();
var so, co = (so = class extends G {
	constructor(...e) {
	...
	async _fetch() {
		...
		if (n.length) try {
			let r = await Xa(this.hass, n, "day", Ja("day", 1));
  ...
  `, so);
B([T()], co.prototype, "_import", void 0), B([T()], co.prototype, "_export", void 0), B([T()], co.prototype, "_ready", void 0), co = B([D("hd-widget-electricitytotal")], co), C(), E(), O(), K(), N(), I(), nr(), z(), W(), lr(), hr(), V();
var lo, uo, fo, po = (lo = class extends G {
	constructor(...e) {
  ...
  `, lo);
po = B([D("hd-widget-fan")], po);
var mo = (uo = class extends G {
	constructor(...e) {
  ...
  `, uo);
B([T()], mo.prototype, "_cacheBust", void 0), mo = B([D("hd-widget-camera")], mo);
var ho = (fo = class extends G {
	async _call(e, t) {
	...
	renderContent() {
      ...
      @hd-activate=${() => this.openDetail()}
    >
      ${r === "1x1" ? b : v`<div class="controls" @click=${(e) => e.stopPropagation()}>
            ${i ? v`<button class="danger" @click=${() => this._call("alarm_disarm", !0)}>Disarm</button>` : v`<button @click=${() => this._call("alarm_arm_home", !1)}>Arm home</button>
...
function yo(e) {
	let t = Dr(e);
	return t ? (vo(e), t.tag) : go[e] ?? "hd-widget-sensor";
}
C(), W();
function bo(e, t, n, r, i = "row") {
	try {
		let { colSpan: a, rowSpan: o } = di(t, n), s = Ci(yo(e.type));
		return Ti`<${s}
      class="cell"
    ...
    ></${s}>`;
		...
		return console.error(`[widget-cell] widget "${e?.id ?? e?.type}" failed to render:`, r), xo(e, t, n);
	}
}
function xo(e, t, n) {
	let r = 1, i = 1;
	try {
		({colSpan: r, rowSpan: i} = di(t, n));
	} catch {}
...
C(), E(), O(), z(), H(), V();
var So, Co = 960, wo = 720;
function To(e, t) {
	if (!e || !t) return [];
	let n = (t) => t ? wa(e.states[t]) : null, r = n(t.gridPower) ?? 0, i = n(t.solarPower) ?? 0, a = n(t.carPower) ?? 0, o = t.carConnected ? e.states[t.carConnected]?.state === "on" : !1, s = i + r - a, c = [];
...
var Eo = (So = class extends S {
	...
	render() {
		let e = this.options, t = this._num(e?.solar), n = this._num(e?.grid), r = n != null && t != null ? n + t : null, i = To(this.hass, e);
		return v`
      <div class="hero">
        <div class="inner">
          <div class="bar">
          ...
          <div class="house">
            <img
              class="house-art"
              src=${_a("assets/energy-house.webp")}
              alt=""
              aria-hidden="true"
            />
            ${si(i, (e) => e, (e) => v`
                <img
                  class="flow"
                  src=${_a(`assets/energy-flows/${e}${this._reduce ? "-still" : ""}.webp`)}
                  alt=""
                  aria-hidden="true"
                  decoding="async"
                />
  ...
  `, So);
B([w({ attribute: !1 })], Eo.prototype, "hass", void 0), B([w({ attribute: !1 })], Eo.prototype, "options", void 0), Eo = B([D("hd-energy-hero")], Eo), C(), E(), O(), H(), W(), V();
var Do, Oo = (Do = class extends S {
	constructor(...e) {
		super(...e), this._elementWidth = new Gr(this);
	}
	render() {
		let e = this.view, t = ci(this._elementWidth.width), n = `--pad:${t.pad}px`, r = e?.hero ? v`<hd-energy-hero .hass=${this.hass} .options=${e.hero}></hd-energy-hero>` : b;
      ...
      <div class="stack" style=${n}>
        ${si(i, (e) => e.id, (e) => bo(e, li(e, t.bucket), 1, this.hass, "row"))}
      </div>
      ${b}
    `;
	}
  ...
  `, Do);
B([w({ attribute: !1 })], Oo.prototype, "hass", void 0), B([w({ attribute: !1 })], Oo.prototype, "view", void 0), Oo = B([D("hd-view-grid")], Oo), C(), N(), I(), z();
function ko(e, t) {
    ...
    ${n.targetTemp ? v`<div class="d-section climate-hero">
          ...
          <div class="climate-target">
            ...
            ${a == null ? b : v`<span class="sub">Now ${L(a)}°</span>`}
          </div>
          <hd-icon-button
            icon="mdi:plus"
            label="Raise"
    ...
    ${d.map((t) => {
        ...
        <hd-toggle
          .checked=${n}
          label=${t.name}
          @hd-toggle=${() => e.call(P(t.entity), `toggle ${t.name.toLowerCase()}`)}
        ></hd-toggle>
      </div>`;
	})}
  `;
...
function Mo(e, t) {
	let n = Dt(t), r = t.state === "on", i = r ? Math.round((t.attributes.brightness ?? 255) / 2.55) : 0, a = t.attributes.min_color_temp_kelvin ?? 2200, o = t.attributes.max_color_temp_kelvin ?? 6500, s = t.attributes.color_temp_kelvin ?? Math.round((a + o) / 2), c = t.attributes.effect_list?.filter((e) => e && e !== "None") ?? [], l = t.attributes.hs_color, u = t.attributes.rgb_color, [d, f] = l ? [l[0], l[1]] : u ? jo(u) : [0, 0];
	return v`
    <div class="d-section d-row-between">
      ...
      <hd-toggle
        .checked=${r}
        label="Toggle light"
        @hd-toggle=${() => e.call(P(e.entityId), "toggle")}
      ></hd-toggle>
    </div>
...
C(), I(), jn(), N(), z(), nr();
function No(e, t) {
	let n = At(t), r = t.attributes.entity_picture, i = t.attributes.media_title, a = t.attributes.app_name, o = t.attributes.volume_level ?? 0, s = t.attributes.is_volume_muted ?? !1, c = t.attributes.source_list ?? [], l = t.attributes.sound_mode_list ?? [], u = t.state === "off", d = n.selectSource && ea(c), { featured: f, rest: p } = d ? ra(c) : {
		featured: [],
		rest: c
	}, m = async (t) => {
		u && await e.call(zt(e.entityId), "turn on"), await e.call(rn(e.entityId, t), d ? "launch" : "change source of");
	}, h = !u && t.state !== "idle" && t.state !== "standby", ee = a ? $i(a) : void 0, te = ia(t);
	return v`
    ...
    ${te ? v`<div class="d-section media-progress">
    ...
    <div class="d-section media-transport">
      ${n.power ? v`<hd-icon-button icon="mdi:power" label=${u ? "Turn on" : "Turn off"} variant=${u ? "soft" : "filled"} @click=${() => e.call(P(e.entityId), u ? "turn on" : "turn off")}></hd-icon-button>` : b}
      ${n.previous ? v`<hd-icon-button icon="mdi:skip-previous" label="Previous" variant="soft" .disabled=${u} @click=${() => e.call(en(e.entityId), "skip")}></hd-icon-button>` : b}
      <hd-icon-button icon=${t.state === "playing" ? "mdi:pause" : "mdi:play"} label="Play or pause" variant="filled" .disabled=${u} @click=${() => e.call(Qt(e.entityId), "control")}></hd-icon-button>
      ${n.next ? v`<hd-icon-button icon="mdi:skip-next" label="Next" variant="soft" .disabled=${u} @click=${() => e.call($t(e.entityId), "skip")}></hd-icon-button>` : b}
    </div>
    ${n.volumeSet ? v`<div class="d-section">
          <span class="d-label">Volume</span>
          <div class="vol-row">
            ${n.mute ? v`<hd-icon-button icon=${s ? "mdi:volume-off" : "mdi:volume-high"} label="Mute" variant="soft" @click=${() => e.call(nn(e.entityId, !s), "mute")}></hd-icon-button>` : b}
            <hd-slider style="flex:1" .value=${Math.round(o * 100)} .valueText=${`${Math.round(o * 100)}%`} label="Volume"
              @hd-change=${(t) => e.call(tn(e.entityId, t.detail.value / 100), "set volume of")}></hd-slider>
          </div>
        </div>` : b}
    ${n.selectSoundMode && l.length ? v`<div class="d-section">
          <span class="d-label">Sound mode</span>
          <div class="chips">
            ${l.map((n) => v`<button class="chip ${t.attributes.sound_mode === n ? "active" : ""}" @click=${() => e.call(an(e.entityId, n), "set sound mode of")}>${n}</button>`)}
          </div>
        </div>` : b}
    ...
    ${n.selectSource && p.length ? v`<div class="d-section">
          ...
          <div class="chips">
            ${p.slice(0, 24).map((e) => {
		let n = t.attributes.source === e, r = d ? $i(e) ?? "mdi:apps" : void 0;
		return v`<button
                class="chip ${r ? "with-icon" : ""} ${n ? "active" : ""}"
                @click=${() => m(e)}
              >
                ${r ? v`<hd-icon icon=${r} .size=${18}></hd-icon>` : b}<span>${e}</span>
              </button>`;
	})}
          </div>
        </div>` : b}
...
function Po(e, t) {
    ...
    ${n.setPosition ? v`<div class="d-section">
          ...
          <hd-slider .value=${r} .valueText=${`${Math.round(r)}% open`} label="Position"
            @hd-change=${(t) => e.call(Zt(e.entityId, t.detail.value), "move")}></hd-slider>
        </div>` : b}
    <div class="d-section big-buttons">
      ${n.open ? v`<button class="bigbtn" @click=${() => e.call(Jt(e.entityId), "open")}><hd-icon icon="mdi:arrow-up" .size=${20}></hd-icon>Open</button>` : b}
      ${n.stop ? v`<button class="bigbtn" @click=${() => e.call(Xt(e.entityId), "stop")}><hd-icon icon="mdi:stop" .size=${20}></hd-icon>Stop</button>` : b}
      ${n.close ? v`<button class="bigbtn" @click=${() => e.call(Yt(e.entityId), "close")}><hd-icon icon="mdi:arrow-down" .size=${20}></hd-icon>Close</button>` : b}
    </div>
  `;
}
function Fo(e, t) {
	...
	return v`
    <div class="d-section big-buttons">
      <button class="bigbtn ${n ? "active" : ""}" @click=${() => e.call(dn(e.entityId), "lock")}>
...
function Io(e, t) {
	let n = jt(t), r = (t.attributes.fan_speed_list ?? []).filter((e) => !["off", "custom"].includes(e)), i = kn(e.hass, e.entityId), a = i.battery ?? t.attributes.battery_level, o = t.state === "cleaning", s = [];
	return typeof i.progress == "number" && o && s.push(["Progress", `${Math.round(i.progress)}%`]), typeof i.area == "number" && i.area > 0 && s.push(["Area", `${L(i.area)} m²`]), typeof i.cleaningTime == "number" && i.cleaningTime > 0 && s.push(["Time", `${Math.round(i.cleaningTime)} min`]), v`
    <div class="d-section big-buttons">
      <button class="bigbtn" @click=${() => e.call(on(e.entityId), "start")}><hd-icon icon="mdi:play" .size=${20}></hd-icon>Start</button>
      ${n.pause ? v`<button class="bigbtn" @click=${() => e.call(sn(e.entityId), "pause")}><hd-icon icon="mdi:pause" .size=${20}></hd-icon>Pause</button>` : b}
      ${n.returnHome ? v`<button class="bigbtn" @click=${() => e.call(cn(e.entityId), "dock")}><hd-icon icon="mdi:home-import-outline" .size=${20}></hd-icon>Dock</button>` : b}
      ${n.locate ? v`<button class="bigbtn" @click=${() => e.call(un(e.entityId), "locate")}><hd-icon icon="mdi:map-marker-radius" .size=${20}></hd-icon>Locate</button>` : b}
    </div>
    ${r.length ? v`<div class="d-section">
		...
		label: R(e)
            ...
            @hd-select=${(t) => e.call(ln(e.entityId, t.detail.value), "set suction for")}></hd-segmented>
        </div>` : b}
    ${s.length ? v`<div class="d-section">
          <span class="d-label">${o ? i.room ? `Cleaning ${i.room}` : "Current clean" : "Last clean"}</span>
          <div class="d-grid">
            ${s.map(([e, t]) => v`<div class="d-cell"><span class="k">${e}</span><span class="v">${t}</span></div>`)}
          </div>
        </div>` : b}
    ...
    ${a == null ? b : v`<div class="d-meta">Battery ${Math.round(a)}%${i.status ? ` · ${R(i.status.replace(/_/g, " "))}` : ""}</div>`}
  `;
}
function Lo(e, t) {
	let n = Number(t.state), r = Number.isFinite(n), i = e.trend, a = i.length > 1 ? `Min ${L(Math.min(...i))}, max ${L(Math.max(...i))}, latest ${L(i[i.length - 1])}` : "";
	return v`
    <div class="d-value big">${bn(e.hass, t)}</div>
    ${r && i.length > 1 ? v`<div class="d-section">
...
function Ro(e, t) {
	...
	return n.temperature != null && r.push(["Temperature", `${L(n.temperature)}°`]), n.humidity != null && r.push(["Humidity", `${Math.round(n.humidity)}%`]), n.wind_speed != null && r.push(["Wind", `${L(n.wind_speed)} ${n.wind_speed_unit ?? ""}`]), n.pressure != null && r.push(["Pressure", `${L(n.pressure)} ${n.pressure_unit ?? ""}`]), v`
    <div class="d-value big">${R(t.state)}</div>
    <div class="d-grid">
      ${r.map(([e, t]) => v`<div class="d-cell"><span class="k">${e}</span><span class="v">${t}</span></div>`)}
    </div>
...
function zo(e) {
    ...
    <div class="d-section">
      ...
      <div class="d-grid">
        ${r.map((t) => v`<div class="d-cell"><span class="k">${R(t.k)}</span><span class="v">${bn(e.hass, t.st)}</span></div>`)}
      </div>
    </div>
...
function Bo(e) {
	let t = e.config?.type === "powerflow" ? e.config.options ?? {} : {}, n = Aa(e.hass, t), r = (t, n) => {
		let r = n ? e.hass.states[n] : void 0;
		return r ? v`<div class="d-cell"><span class="k">${t}</span><span class="v">${bn(e.hass, r)}</span></div>` : b;
	};
	return v`
...
function Vo(e) {
	let t = e.config?.type === "solarcharging" ? e.config.options ?? {} : {}, n = Ga(e.hass, t), r = n.tone === "eco" ? "var(--state-eco)" : n.tone === "accent" ? "var(--accent)" : "var(--text-secondary)", i = (e, t) => t == null ? b : v`<div class="d-cell"><span class="k">${e}</span><span class="v">${t}</span></div>`, a = (t, n, r, i) => {
    ...
    <div class="d-section d-row-between">
      ...
      <hd-toggle
        ...
        @hd-toggle=${() => t.master ? e.call(P(t.master), "toggle solar charging") : void 0}
      ></hd-toggle>
    </div>
...
function Ho(e, t) {
    ...
    ${r ? v`<div class="d-section big-buttons">
          <button class="bigbtn" @click=${() => e.call(zt(e.entityId), "turn on")}>Turn on</button>
          <button class="bigbtn" @click=${() => e.call(Bt(e.entityId), "turn off")}>Turn off</button>
        </div>` : b}
    ${Uo(e, t)}
  `;
}
function Uo(e, t) {
    ...
    ${n.map((n) => v`<div class="d-cell"><span class="k">${R(n)}</span><span class="v">${xn(e.hass, t, n)}</span></div>`)}
    <div class="d-cell"><span class="k">Last updated</span><span class="v">${Cn(t.last_updated)}</span></div>
  </div>`;
}
function Wo(e) {
	return {
...
B([w({
	type: Boolean,
	reflect: !0
})], Zo.prototype, "checked", void 0), B([w({
	type: Boolean,
	reflect: !0
})], Zo.prototype, "disabled", void 0), B([w({ type: String })], Zo.prototype, "label", void 0), Zo = B([D("hd-toggle")], Zo);
//#endregion
//#region src/primitives/color-wheel.ts
var Qo = /* @__PURE__ */ n({ HdColorWheel: () => es }), $o, es, ts = t((() => {
	C(), E(), O(), V(), es = ($o = class extends S {
		constructor(...e) {
  ...
  `, $o), B([w({ type: Number })], es.prototype, "hue", void 0), B([w({ type: Number })], es.prototype, "sat", void 0), B([w({
		type: Boolean,
		reflect: !0
	})], es.prototype, "disabled", void 0), es = B([D("hd-color-wheel")], es);
}));
C(), E(), O(), I(), $n(), nr(), Nr(), lr(), vr(), hr(), H(), V();
var ns, Q = (ns = class extends S {
	constructor(...e) {
	...
	async _maybeLoad() {
		...
		this._loadedKey = e, this._trend.length && (this._trend = []), this._forecast.length && (this._forecast = []), this.entityId.startsWith("light.") && (this.hass.states[this.entityId]?.attributes.supported_color_modes)?.some((e) => [
			...
			"rgbww",
			"rgbwww"
		].includes(e)) && Promise.resolve().then(() => (ts(), Qo));
	...
	render() {
		...
		let e = Rn(this.hass, this.entityId, this.config), t = {
			...
			call: this._call
		}, n = this.config?.type === "energy" ? "Live energy" : this.config?.type === "powerflow" ? "Live power flow" : e.displayState, r = this.config ? Dr(this.config.type) : void 0, i = this.hass.states[this.entityId], a = this.open && r?.detailRenderer && i ? Yo(r.detailRenderer, t, i) : this.open ? Go(t) : b;
		return v`
      <hd-surface
        variant="auto"
        .open=${this.open}
  ...
  `, ns);
B([w({ attribute: !1 })], Q.prototype, "hass", void 0), B([w({
	type: Boolean,
	reflect: !0
})], Q.prototype, "open", void 0), B([w({ type: String })], Q.prototype, "entityId", void 0), B([w({ attribute: !1 })], Q.prototype, "config", void 0), B([T()], Q.prototype, "_trend", void 0), B([T()], Q.prototype, "_forecast", void 0), Q = B([D("hd-detail")], Q), C(), E(), O(), H(), V();
var rs, is = (rs = class extends S {
	constructor(...e) {
  ...
  `, rs);
B([T()], is.prototype, "_open", void 0), B([T()], is.prototype, "_opts", void 0), is = B([D("hd-confirm")], is), C(), E(), O(), H(), V();
var as, os = (as = class extends S {
	constructor(...e) {
  ...
  `, as);
B([T()], os.prototype, "_toasts", void 0), os = B([D("hd-toasts")], os), C(), E(), O(), zr(), V();
var ss, cs = "hd-panel-appearance", $ = (ss = class extends S {
	constructor(...e) {
	...
	_syncViewFromLocation() {
		let e = Br(this.route, this._base) || this._cfg.config.defaultView, t = this._views.some((t) => t.id === e);
		this._viewId = t ? e : this._cfg.config.defaultView;
	}
	_onNavigate(e) {
		e !== this._viewId && (this._viewId = e, Wr(Ur(this._base, e, this._cfg.config.defaultView)), this.updateComplete.then(() => this.renderRoot.querySelector("hd-app-shell")?.scrollToTop()));
	}
	_resolveDark() {
	...
	_cycleAppearance() {
		this._appearance = this._appearance === "auto" ? "light" : this._appearance === "light" ? "dark" : "auto", localStorage.setItem(cs, this._appearance), this._applyTheme();
	}
	_applyKiosk() {
...
B([w({ attribute: !1 })], $.prototype, "hass", void 0), B([w({ type: Boolean })], $.prototype, "narrow", void 0), B([w({ attribute: !1 })], $.prototype, "panel", void 0), B([w({ attribute: !1 })], $.prototype, "route", void 0), B([T()], $.prototype, "_viewId", void 0), B([T()], $.prototype, "_appearance", void 0), B([T()], $.prototype, "_detailOpen", void 0), B([T()], $.prototype, "_detailEntityId", void 0), B([T()], $.prototype, "_detailConfig", void 0), B([ct("hd-confirm")], $.prototype, "_confirm", void 0), B([ct("hd-toasts")], $.prototype, "_toasts", void 0), $ = B([D("home-dashboard-panel")], $);
//#endregion
